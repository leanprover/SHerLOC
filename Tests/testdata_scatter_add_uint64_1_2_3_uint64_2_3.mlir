"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<1x2x3xui64>, tensor<2x3xui64>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[1, 5, 1], [1, 1, 0]]]> : tensor<1x2x3xui64>}> : () -> tensor<1x2x3xui64>
    %2 = "stablehlo.constant"() <{value = dense<[[0, 2, 0], [0, 0, 1]]> : tensor<2x3xui64>}> : () -> tensor<2x3xui64>
  ...
  "func.func"() <{function_type = () -> tensor<1x2x3xui64>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[1, 7, 1], [1, 1, 1]]]> : tensor<1x2x3xui64>}> : () -> tensor<1x2x3xui64>
