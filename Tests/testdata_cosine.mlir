...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "cosine_op_test_f32"}> ({
    ...
    %1 = "stablehlo.cosine"(%0) : (tensor<11xf32>) -> tensor<11xf32>
    "check.expect_almost_eq_const"(%1) <{value = dense<[1.000000e+00, 1.000000e+00, 0.540302277, 0.992197692, 0.995004177, -1.000000e+00, 0xFFC00000, 0xFFC00000, 0x7FFFFFFF, 1.000000e+00, 1.000000e+00]> : tensor<11xf32>}> : (tensor<11xf32>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
