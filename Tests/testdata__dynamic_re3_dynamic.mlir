"builtin.module"() <{sym_name = "jit_fun_flat_jax"}> ({
  "func.func"() <{arg_attrs = [{}, {}, {mhlo.sharding = ""}], function_type = (tensor<i64>, tensor<i64>, tensor<?x4x?x6x7xf32>) -> tensor<2x?xf32>, sym_name = "main", sym_visibility = "public"}> ({
  ^bb0(%arg0: tensor<i64>, %arg1: tensor<i64>, %arg2: tensor<?x4x?x6x7xf32>):
    %0 = "stablehlo.multiply"(%arg0, %arg1) : (tensor<i64>, tensor<i64>) -> tensor<i64>
    %1 = "stablehlo.constant"() <{value = dense<84> : tensor<i64>}> : () -> tensor<i64>
