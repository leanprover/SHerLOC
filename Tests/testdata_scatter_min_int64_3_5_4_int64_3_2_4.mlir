"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<3x5x4xi64>, tensor<3x2x4xi64>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[0, -2, -2, 2], [9, 0, 3, 0], [3, 3, -3, 2], [3, 1, -2, 3], [-1, 0, 5, -4]], [[0, -1, -2, 0], [0, 3, -3, 6], [-3, -6, 2, 0], [-2, -3, 0, 1], [0, 1, 1, 0]], [[3, 4, -2, -3], [-1, 1, 0, 2], [0, -2, 0, -2], [-5, 1, 2, 0], [0, -1, 3, -2]]]> : tensor<3x5x4xi64>}> : () -> tensor<3x5x4xi64>
    %2 = "stablehlo.constant"() <{value = dense<[[[1, 0, -3, -3], [2, -5, 2, 6]], [[-1, 0, 2, -3], [4, 2, -5, -8]], [[3, 3, 2, 0], [0, 0, 3, 6]]]> : tensor<3x2x4xi64>}> : () -> tensor<3x2x4xi64>
  ...
  "func.func"() <{function_type = () -> tensor<3x5x4xi64>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[0, -2, -2, 2], [1, -5, -3, -3], [3, 3, -3, 2], [3, 1, -2, 3], [-1, 0, 5, -4]], [[0, -1, -2, 0], [-1, 0, -5, -8], [-3, -6, 2, 0], [-2, -3, 0, 1], [0, 1, 1, 0]], [[3, 4, -2, -3], [-1, 0, 0, 0], [0, -2, 0, -2], [-5, 1, 2, 0], [0, -1, 3, -2]]]> : tensor<3x5x4xi64>}> : () -> tensor<3x5x4xi64>
