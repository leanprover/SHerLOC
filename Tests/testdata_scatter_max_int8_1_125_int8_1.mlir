"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<1x125xi8>, tensor<1xi8>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<"0x0101FEFBFD02FE03FE04FFFEFFFFFE01FF04FF030001FD00FE0303030002FF04FF00FE03FC020006FF010001FDFF0005000301FAFE03FDFB0202FEFE0002FE02000005FFFD010200FEFCF8030200FCFD03020300FF03FA030300FF01010403040105FDFEFE04FEFE030200020505FFFFFFFFFE00000301000100FB01FD"> : tensor<1x125xi8>}> : () -> tensor<1x125xi8>
  ...
  "func.func"() <{function_type = () -> tensor<1x125xi8>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<"0x0101FEFBFD02FE03FE04FFFEFFFFFE01FF04FF030001FD00FE0303030002FF04FF00FE03FC020006FF010001FDFF0005000301FAFE03FDFB0202FEFE0002FE02000005FFFD010200FEFCF8030200FCFD03020300FF03FA030300FF01010403040105FDFEFE04FEFE030200020505FFFFFFFFFE00000301000100FB01FD"> : tensor<1x125xi8>}> : () -> tensor<1x125xi8>
