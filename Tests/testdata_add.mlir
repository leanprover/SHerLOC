...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "add_op_test_f32"}> ({
    ...
    %2 = "stablehlo.add"(%0, %1) : (tensor<11xf32>, tensor<11xf32>) -> tensor<11xf32>
    "check.expect_almost_eq_const"(%2) <{value = dense<[0.000000e+00, -0.000000e+00, 8.000000e+00, 8.750000e-01, 4.000000e-01, 6.28318548, 0x7F800000, 0x7F800000, 0xFF800000, 0x7FC00000, 0.000000e+00]> : tensor<11xf32>}> : (tensor<11xf32>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "add_op_test_c64"}> ({
    ...
    %2 = "stablehlo.add"(%0, %1) : (tensor<2xcomplex<f32>>, tensor<2xcomplex<f32>>) -> tensor<2xcomplex<f32>>
    "check.expect_almost_eq_const"(%2) <{value = dense<[(3.000000e+00,5.000000e+00), (1.500000e+01,1.100000e+01)]> : tensor<2xcomplex<f32>>}> : (tensor<2xcomplex<f32>>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "add_op_test_c128"}> ({
    ...
    %2 = "stablehlo.add"(%0, %1) : (tensor<2xcomplex<f64>>, tensor<2xcomplex<f64>>) -> tensor<2xcomplex<f64>>
    "check.expect_almost_eq_const"(%2) <{value = dense<[(3.000000e+00,5.000000e+00), (1.500000e+01,1.100000e+01)]> : tensor<2xcomplex<f64>>}> : (tensor<2xcomplex<f64>>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
