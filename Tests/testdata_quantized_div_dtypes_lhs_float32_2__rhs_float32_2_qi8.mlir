"builtin.module"() ({
  "func.func"() <{function_type = () -> tensor<2xf32>, sym_name = "main"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[-1.51913178, -1.08529949]> : tensor<2xf32>}> : () -> tensor<2xf32>
    %1 = "stablehlo.constant"() <{value = dense<[2.67503524, -1.21969211]> : tensor<2xf32>}> : () -> tensor<2xf32>
    %2 = "stablehlo.constant"() <{value = dense<[0.000000e+00, 91.4060898]> : tensor<2xf32>}> : () -> tensor<2xf32>
