"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<4x2x3xi64>, tensor<2xi64>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[2, 3, 1], [0, 4, -2]], [[0, -1, -1], [-3, -1, -4]], [[-3, 2, 0], [-1, -2, -1]], [[-5, 0, -1], [3, -3, 0]]]> : tensor<4x2x3xi64>}> : () -> tensor<4x2x3xi64>
    %2 = "stablehlo.constant"() <{value = dense<[-2, 0]> : tensor<2xi64>}> : () -> tensor<2xi64>
  ...
  "func.func"() <{function_type = () -> tensor<4x2x3xi64>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[2, 3, 1], [0, 4, -2]], [[0, -1, -1], [-3, -1, -4]], [[-3, 2, 0], [-1, -2, -1]], [[-5, 0, -1], [3, -3, 0]]]> : tensor<4x2x3xi64>}> : () -> tensor<4x2x3xi64>
