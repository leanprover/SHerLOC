"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "log_plus_one_op_test_f64"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[0.000000e+00, -0.99899999999999999, 7.000000e+00, 6.3890562099999997, 1.500000e+01]> : tensor<5xf64>}> : () -> tensor<5xf64>
    %1 = "stablehlo.log_plus_one"(%0) : (tensor<5xf64>) -> tensor<5xf64>
    "check.expect_almost_eq_const"(%1) <{value = dense<[0.000000e+00, -6.9077682500000002, 2.0794415499999999, 2.000000e+00, 2.7725887299999998]> : tensor<5xf64>}> : (tensor<5xf64>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
