"builtin.module"() <{sym_name = "jit_fun_flat_jax"}> ({
  ...
  ^bb0(%arg6: tensor<i64>, %arg7: tensor<?x15xf32>):
    %17 = "func.call"(%arg6, %arg7) <{callee = @argmin}> : (tensor<i64>, tensor<?x15xf32>) -> tensor<?xui8>
    "func.return"(%17) : (tensor<?xui8>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = (tensor<i64>, tensor<?x15xf32>) -> tensor<?xui8>, sym_name = "argmin", sym_visibility = "private"}> ({
