"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "tanh_op_test_bf16"}> ({
    ...
    %1 = "stablehlo.tanh"(%0) : (tensor<11xbf16>) -> tensor<11xbf16>
    "check.expect_almost_eq_const"(%1) <{value = dense<[0.000000e+00, -0.000000e+00, 7.617180e-01, 1.245120e-01, 9.960930e-02, 9.960930e-01, 1.000000e+00, -1.000000e+00, 0x7FFF, 9.183550e-41, -9.183550e-41]> : tensor<11xbf16>}> : (tensor<11xbf16>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "tanh_op_test_f16"}> ({
    ...
    %1 = "stablehlo.tanh"(%0) : (tensor<11xf16>) -> tensor<11xf16>
    "check.expect_almost_eq_const"(%1) <{value = dense<[0.000000e+00, -0.000000e+00, 7.617180e-01, 1.243290e-01, 9.967040e-02, 9.960930e-01, 1.000000e+00, -1.000000e+00, 0x7FFF, 5.960460e-08, -5.960460e-08]> : tensor<11xf16>}> : (tensor<11xf16>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() <{function_type = () -> tensor<11xf32>, sym_name = "main"}> ({
    ...
    %1 = "stablehlo.constant"() <{value = dense<[0.000000e+00, 0.000000e+00, 0.761130392, 0.12536265, 0.101484053, 0.761130392, 0.761130392, 0.000000e+00, 0.462647885, 0.000000e+00, 0.000000e+00]> : tensor<11xf32>}> : () -> tensor<11xf32>
    %2 = "stablehlo.uniform_quantize"(%0) : (tensor<11xf32>) -> tensor<11x!quant.uniform<i8:f32, 0.0039172410964965817:-128>>
    %3 = "stablehlo.tanh"(%2) : (tensor<11x!quant.uniform<i8:f32, 0.0039172410964965817:-128>>) -> tensor<11x!quant.uniform<i8:f32, 0.0029848250688291065:-128>>
    %4 = "stablehlo.uniform_dequantize"(%3) : (tensor<11x!quant.uniform<i8:f32, 0.0029848250688291065:-128>>) -> tensor<11xf32>
...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "tanh_op_test_f64"}> ({
    ...
    %1 = "stablehlo.tanh"(%0) : (tensor<11xf64>) -> tensor<11xf64>
    "check.expect_almost_eq_const"(%1) <{value = dense<[0.000000e+00, -0.000000e+00, 0.76159415595576485, 0.12435300177159619, 0.099667994624955819, 0.99627207622074998, 1.000000e+00, -1.000000e+00, 0x7FFFFFFFFFFFFFFF, 4.940660e-324, -4.940660e-324]> : tensor<11xf64>}> : (tensor<11xf64>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "tanh_op_test_c32"}> ({
    ...
    %1 = "stablehlo.tanh"(%0) : (tensor<2xcomplex<f32>>) -> tensor<2xcomplex<f32>>
    "check.expect_almost_eq_const"(%1) <{value = dense<[(0.967786788,-0.0926378369), (1.00166273,7.52857188E-4)]> : tensor<2xcomplex<f32>>}> : (tensor<2xcomplex<f32>>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
