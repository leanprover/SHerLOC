"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<4x2x3xui64>, tensor<2xui64>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[0, 7, 5], [3, 4, 0]], [[0, 0, 0], [3, 0, 0]], [[4, 2, 1], [4, 0, 0]], [[0, 3, 2], [0, 2, 0]]]> : tensor<4x2x3xui64>}> : () -> tensor<4x2x3xui64>
    %2 = "stablehlo.constant"() <{value = dense<[0, 1]> : tensor<2xui64>}> : () -> tensor<2xui64>
  ...
  "func.func"() <{function_type = () -> tensor<4x2x3xui64>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[0, 7, 5], [3, 4, 0]], [[0, 0, 0], [3, 0, 0]], [[4, 2, 1], [4, 0, 0]], [[0, 3, 0], [0, 2, 1]]]> : tensor<4x2x3xui64>}> : () -> tensor<4x2x3xui64>
