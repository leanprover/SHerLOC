"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<1xui16>, tensor<2xui16>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<2> : tensor<1xui16>}> : () -> tensor<1xui16>
    %2 = "stablehlo.constant"() <{value = dense<[2, 3]> : tensor<2xui16>}> : () -> tensor<2xui16>
  ...
  "func.func"() <{function_type = () -> tensor<1xui16>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<12> : tensor<1xui16>}> : () -> tensor<1xui16>
