"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<3x5x4xui64>, tensor<3x2x4xui64>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[5, 2, 3, 3], [3, 1, 1, 1], [3, 4, 0, 3], [1, 4, 0, 2], [2, 1, 1, 4]], [[3, 2, 2, 5], [0, 1, 1, 1], [3, 2, 3, 1], [0, 2, 1, 1], [0, 3, 1, 1]], [[4, 0, 0, 5], [2, 4, 1, 4], [0, 3, 4, 2], [0, 2, 2, 0], [4, 0, 0, 6]]]> : tensor<3x5x4xui64>}> : () -> tensor<3x5x4xui64>
    %2 = "stablehlo.constant"() <{value = dense<[[[2, 0, 1, 2], [2, 1, 0, 0]], [[1, 5, 0, 3], [1, 6, 2, 4]], [[0, 3, 9, 3], [3, 2, 3, 0]]]> : tensor<3x2x4xui64>}> : () -> tensor<3x2x4xui64>
  ...
  "func.func"() <{function_type = () -> tensor<3x5x4xui64>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[5, 2, 3, 3], [7, 2, 2, 3], [3, 4, 0, 3], [1, 4, 0, 2], [2, 1, 1, 4]], [[3, 2, 2, 5], [2, 12, 3, 8], [3, 2, 3, 1], [0, 2, 1, 1], [0, 3, 1, 1]], [[4, 0, 0, 5], [5, 9, 13, 7], [0, 3, 4, 2], [0, 2, 2, 0], [4, 0, 0, 6]]]> : tensor<3x5x4xui64>}> : () -> tensor<3x5x4xui64>
