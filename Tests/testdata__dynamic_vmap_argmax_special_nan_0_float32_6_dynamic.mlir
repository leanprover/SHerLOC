"builtin.module"() <{sym_name = "jit_fun_flat_jax"}> ({
  "func.func"() <{arg_attrs = [{}, {mhlo.sharding = ""}], function_type = (tensor<i64>, tensor<?x6xf32>) -> tensor<?xi32>, sym_name = "main", sym_visibility = "public"}> ({
  ^bb0(%arg6: tensor<i64>, %arg7: tensor<?x6xf32>):
    %17 = "func.call"(%arg6, %arg7) <{callee = @argmax}> : (tensor<i64>, tensor<?x6xf32>) -> tensor<?xi32>
    "func.return"(%17) : (tensor<?xi32>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = (tensor<i64>, tensor<?x6xf32>) -> tensor<?xi32>, sym_name = "argmax", sym_visibility = "private"}> ({
  ^bb0(%arg0: tensor<i64>, %arg1: tensor<?x6xf32>):
    ...
    %4 = "stablehlo.dynamic_iota"(%3) <{iota_dimension = 1 : i64}> : (tensor<2xi32>) -> tensor<?x6xi32>
    ...
    }) : (tensor<?x6xf32>, tensor<?x6xi32>, tensor<f32>, tensor<i32>) -> (tensor<?xf32>, tensor<?xi32>)
