"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<4x2x3xui8>, tensor<2xui8>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[1, 3, 1], [3, 2, 0]], [[4, 1, 9], [0, 2, 2]], [[1, 2, 2], [3, 2, 0]], [[2, 0, 0], [1, 2, 3]]]> : tensor<4x2x3xui8>}> : () -> tensor<4x2x3xui8>
    %2 = "stablehlo.constant"() <{value = dense<[5, 4]> : tensor<2xui8>}> : () -> tensor<2xui8>
  ...
  "func.func"() <{function_type = () -> tensor<4x2x3xui8>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[1, 3, 1], [3, 2, 0]], [[4, 1, 9], [0, 2, 2]], [[1, 2, 2], [3, 2, 0]], [[2, 0, 0], [1, 2, 3]]]> : tensor<4x2x3xui8>}> : () -> tensor<4x2x3xui8>
