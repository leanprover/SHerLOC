"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "abs_op_test_si64"}> ({
    ...
    %1 = "stablehlo.abs"(%0) : (tensor<3xi64>) -> tensor<3xi64>
    "check.expect_eq_const"(%1) <{value = dense<[2, 0, 2]> : tensor<3xi64>}> : (tensor<3xi64>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "abs_op_test_f64"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[2.310000e+01, -2.310000e+01, -0.000000e+00]> : tensor<3xf64>}> : () -> tensor<3xf64>
    %1 = "stablehlo.abs"(%0) : (tensor<3xf64>) -> tensor<3xf64>
    "check.expect_almost_eq_const"(%1) <{value = dense<[2.310000e+01, 2.310000e+01, 0.000000e+00]> : tensor<3xf64>}> : (tensor<3xf64>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
