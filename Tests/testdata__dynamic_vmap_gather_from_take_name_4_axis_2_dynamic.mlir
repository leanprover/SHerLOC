"builtin.module"() <{sym_name = "jit_fun_flat_jax"}> ({
  "func.func"() <{arg_attrs = [{}, {mhlo.sharding = ""}, {mhlo.sharding = ""}], function_type = (tensor<i64>, tensor<?x10x10x10xf32>, tensor<?x2x2xi32>) -> tensor<?x10x10x2x2xf32>, sym_name = "main", sym_visibility = "public"}> ({
  ^bb0(%arg3: tensor<i64>, %arg4: tensor<?x10x10x10xf32>, %arg5: tensor<?x2x2xi32>):
    %16 = "func.call"(%arg3, %arg4, %arg5) <{callee = @_take}> : (tensor<i64>, tensor<?x10x10x10xf32>, tensor<?x2x2xi32>) -> tensor<?x10x10x2x2xf32>
    "func.return"(%16) : (tensor<?x10x10x2x2xf32>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = (tensor<i64>, tensor<?x10x10x10xf32>, tensor<?x2x2xi32>) -> tensor<?x10x10x2x2xf32>, sym_name = "_take", sym_visibility = "private"}> ({
  ^bb0(%arg0: tensor<i64>, %arg1: tensor<?x10x10x10xf32>, %arg2: tensor<?x2x2xi32>):
    ...
    "func.return"(%15) : (tensor<?x10x10x2x2xf32>) -> ()
  }) : () -> ()
}) : () -> ()
