"builtin.module"() <{sym_name = "jit_main"}> ({
  "func.func"() <{function_type = () -> tensor<i32>, res_attrs = [{jax.result_info = "", mhlo.layout_mode = "default"}], sym_name = "main", sym_visibility = "public"}> ({
    ...
    %17 = "func.call"(%15) <{callee = @argmin}> : (tensor<4xf32>) -> tensor<i32>
  ...
  "func.func"() <{function_type = () -> tensor<4xf32>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %14 = "stablehlo.constant"() <{value = dense<[0x7FC00000, 0xFFC00000, 2.000000e+00, -2.000000e+00]> : tensor<4xf32>}> : () -> tensor<4xf32>
  ...
  "func.func"() <{function_type = (tensor<4xf32>) -> tensor<i32>, sym_name = "argmin", sym_visibility = "private"}> ({
