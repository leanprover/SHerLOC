...
"builtin.module"() ({
  "func.func"() <{function_type = () -> tensor<11xf32>, sym_name = "main"}> ({
    ...
    %1 = "stablehlo.constant"() <{value = dense<[0.000000e+00, 0.000000e+00, 0.840874254, 0.125306755, 0.102223933, 0.840874254, 0.840874254, 0.000000e+00, 0.481441736, 0.000000e+00, 0.000000e+00]> : tensor<11xf32>}> : () -> tensor<11xf32>
    %2 = "stablehlo.uniform_quantize"(%0) : (tensor<11xf32>) -> tensor<11x!quant.uniform<i8:f32, 0.0039172410964965817:-128>>
    %3 = "stablehlo.sine"(%2) : (tensor<11x!quant.uniform<i8:f32, 0.0039172410964965817:-128>>) -> tensor<11x!quant.uniform<i8:f32, 0.003297546096876556:-128>>
    %4 = "stablehlo.uniform_dequantize"(%3) : (tensor<11x!quant.uniform<i8:f32, 0.003297546096876556:-128>>) -> tensor<11xf32>
