"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<3xf64>, tensor<3xf64>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[-1.2366298088576739, -3.788709302891704, -4.4442690143501862]> : tensor<3xf64>}> : () -> tensor<3xf64>
    %2 = "stablehlo.constant"() <{value = dense<[1.5729921233969468, 0.80458173420091361, 0.26880308439322337]> : tensor<3xf64>}> : () -> tensor<3xf64>
  ...
  "func.func"() <{function_type = () -> tensor<3xf64>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[-0.99496975617525162, -1.6019615205589499, -4.4442690143501862]> : tensor<3xf64>}> : () -> tensor<3xf64>
