...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "floor_op_test_f32"}> ({
    ...
    %1 = "stablehlo.floor"(%0) : (tensor<9xf32>) -> tensor<9xf32>
    "check.expect_almost_eq_const"(%1) <{value = dense<[0xFF800000, -3.000000e+00, -1.000000e+00, -0.000000e+00, 0.000000e+00, 0.000000e+00, 2.000000e+00, 0x7F800000, 0x7FC00000]> : tensor<9xf32>}> : (tensor<9xf32>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
