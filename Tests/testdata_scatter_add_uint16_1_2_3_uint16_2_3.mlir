"builtin.module"() <{sym_name = "jit_main"}> ({
  "func.func"() <{function_type = () -> tensor<1x2x3xui16>, res_attrs = [{jax.result_info = "", mhlo.layout_mode = "default"}], sym_name = "main", sym_visibility = "public"}> ({
    ...
    %4:2 = "func.call"() <{callee = @inputs}> : () -> (tensor<1x2x3xui16>, tensor<2x3xui16>)
    ...
    }) : (tensor<1x2x3xui16>, tensor<1xi64>, tensor<2x3xui16>) -> tensor<1x2x3xui16>
  ...
  "func.func"() <{function_type = () -> (tensor<1x2x3xui16>, tensor<2x3xui16>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[9, 1, 1], [0, 2, 0]]]> : tensor<1x2x3xui16>}> : () -> tensor<1x2x3xui16>
    %2 = "stablehlo.constant"() <{value = dense<[[1, 3, 3], [7, 4, 2]]> : tensor<2x3xui16>}> : () -> tensor<2x3xui16>
    "func.return"(%1, %2) : (tensor<1x2x3xui16>, tensor<2x3xui16>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = () -> tensor<1x2x3xui16>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[10, 4, 4], [7, 6, 2]]]> : tensor<1x2x3xui16>}> : () -> tensor<1x2x3xui16>
