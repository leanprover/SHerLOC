"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<3xf16>, tensor<3xf16>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[5.929690e+00, -2.326170e+00, -3.642580e-01]> : tensor<3xf16>}> : () -> tensor<3xf16>
    %2 = "stablehlo.constant"() <{value = dense<[-4.289060e+00, 4.214840e+00, -3.269530e+00]> : tensor<3xf16>}> : () -> tensor<3xf16>
  ...
  "func.func"() <{function_type = () -> tensor<3xf16>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[2.500000e+01, -3.262500e+01, -3.642580e-01]> : tensor<3xf16>}> : () -> tensor<3xf16>
