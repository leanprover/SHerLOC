...
"builtin.module"() ({
  "func.func"() <{function_type = () -> tensor<11xf32>, sym_name = "main"}> ({
    ...
    %1 = "stablehlo.constant"() <{value = dense<[0.000000e+00, 0.000000e+00, -0.998896479, -0.125351712, -0.101848267, -0.998896479, -0.998896479, 0.000000e+00, -0.501406848, 0.000000e+00, 0.000000e+00]> : tensor<11xf32>}> : () -> tensor<11xf32>
    %2 = "stablehlo.uniform_quantize"(%0) : (tensor<11xf32>) -> tensor<11x!quant.uniform<i8:f32, 0.0039172410964965817:-128>>
    %3 = "stablehlo.negate"(%2) : (tensor<11x!quant.uniform<i8:f32, 0.0039172410964965817:-128>>) -> tensor<11x!quant.uniform<i8:f32, 0.0039172410964965817:127>>
    %4 = "stablehlo.uniform_dequantize"(%3) : (tensor<11x!quant.uniform<i8:f32, 0.0039172410964965817:127>>) -> tensor<11xf32>
