"builtin.module"() <{sym_name = "jit_fun_flat_jax"}> ({
  "func.func"() <{arg_attrs = [{}, {mhlo.sharding = ""}, {mhlo.sharding = ""}], function_type = (tensor<i64>, tensor<?x2x3xbf16>, tensor<?xbf16>) -> tensor<?x2x1xbf16>, sym_name = "main", sym_visibility = "public"}> ({
  ^bb0(%arg0: tensor<i64>, %arg1: tensor<?x2x3xbf16>, %arg2: tensor<?xbf16>):
    ...
    %1 = "stablehlo.pad"(%arg1, %0) <{edge_padding_high = array<i64: 0, 0, -1>, edge_padding_low = array<i64: 0, 0, -1>, interior_padding = array<i64: 0, 0, 0>}> : (tensor<?x2x3xbf16>, tensor<bf16>) -> tensor<?x2x1xbf16>
    ...
    %10 = "stablehlo.pad"(%8, %9) <{edge_padding_high = array<i64: 0, 0, -1>, edge_padding_low = array<i64: 0, 0, -1>, interior_padding = array<i64: 0, 0, 0>}> : (tensor<?x2x3xi1>, tensor<i1>) -> tensor<?x2x1xi1>
    ...
    %16 = "stablehlo.dynamic_broadcast_in_dim"(%arg2, %15) <{broadcast_dimensions = array<i64: 0>}> : (tensor<?xbf16>, tensor<3xi32>) -> tensor<?x2x1xbf16>
    %17 = "stablehlo.select"(%10, %1, %16) : (tensor<?x2x1xi1>, tensor<?x2x1xbf16>, tensor<?x2x1xbf16>) -> tensor<?x2x1xbf16>
    "func.return"(%17) : (tensor<?x2x1xbf16>) -> ()
  }) : () -> ()
}) : () -> ()
