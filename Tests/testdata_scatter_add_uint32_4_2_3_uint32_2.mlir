"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<4x2x3xui32>, tensor<2xui32>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[4, 1, 5], [2, 2, 0]], [[3, 3, 4], [0, 3, 1]], [[0, 0, 3], [3, 1, 0]], [[2, 6, 3], [1, 2, 0]]]> : tensor<4x2x3xui32>}> : () -> tensor<4x2x3xui32>
    %2 = "stablehlo.constant"() <{value = dense<[1, 4]> : tensor<2xui32>}> : () -> tensor<2xui32>
  ...
  "func.func"() <{function_type = () -> tensor<4x2x3xui32>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[4, 1, 5], [2, 2, 0]], [[3, 3, 4], [0, 3, 1]], [[0, 0, 3], [3, 1, 0]], [[2, 6, 4], [1, 2, 4]]]> : tensor<4x2x3xui32>}> : () -> tensor<4x2x3xui32>
