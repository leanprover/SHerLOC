"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> tensor<8x9xbf16>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %3 = "stablehlo.constant"() <{value = dense<[[-1.929690e+00, -4.625000e+00, 1.460940e+00, 1.890630e+00, -1.546880e+00, 2.250000e+00, -1.984380e+00, 1.179690e+00, 4.570310e-01], [4.718750e+00, -7.937500e+00, 6.562500e+00, -3.578130e+00, 7.851560e-01, -3.750000e-01, -1.476560e+00, -8.300780e-03, 8.750000e-01], [-2.137500e+01, 1.481250e+01, -1.381250e+01, 8.687500e+00, -3.859380e+00, 8.046880e-01, -4.156250e+00, -1.794430e-02, 1.539060e+00], [-3.475000e+01, 2.575000e+01, 1.500000e+01, 3.300000e+01, -3.375000e+00, -9.609370e-01, -6.531250e+00, 8.935540e-02, 1.898440e+00], [-8.200000e+01, 3.550000e+01, -3.468750e+00, 2.437500e+01, 8.312500e+00, -4.656250e+00, -1.131250e+01, -1.953130e-01, 6.906250e+00], [1.310000e+02, -1.212500e+01, 1.256250e+01, -2.900000e+01, -1.468750e+01, -1.381250e+01, 7.200000e+01, 2.070310e-01, -1.368750e+01], [-2.780000e+02, 1.150000e+01, 3.350000e+01, -4.800000e+01, 1.975000e+01, -2.787500e+01, 3.020000e+02, 6.289060e-01, -8.312500e+00], [-9.440000e+02, 1.115000e+02, 8.200000e+01, 1.320000e+02, 5.825000e+01, -2.387500e+01, 1.790000e+02, 2.333980e-01, 7.968750e+00]]> : tensor<8x9xbf16>}> : () -> tensor<8x9xbf16>
    "func.return"(%3) : (tensor<8x9xbf16>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = (tensor<8x9xbf16>) -> tensor<8x9xbf16>, sym_name = "cumprod", sym_visibility = "private"}> ({
  ^bb0(%arg0: tensor<8x9xbf16>):
    ...
    ^bb0(%arg1: tensor<bf16>, %arg2: tensor<bf16>):
      %2 = "stablehlo.multiply"(%arg1, %arg2) : (tensor<bf16>, tensor<bf16>) -> tensor<bf16>
      "stablehlo.return"(%2) : (tensor<bf16>) -> ()
    }) : (tensor<8x9xbf16>, tensor<bf16>) -> tensor<8x9xbf16>
    "func.return"(%1) : (tensor<8x9xbf16>) -> ()
  }) : () -> ()
