"builtin.module"() <{sym_name = "jit_main"}> ({
  "func.func"() <{function_type = () -> tensor<20x20xbf16>, res_attrs = [{jax.result_info = "", mhlo.layout_mode = "default"}], sym_name = "main", sym_visibility = "public"}> ({
    ...
    %90 = "stablehlo.convert"(%89) : (tensor<20x20xf32>) -> tensor<20x20xbf16>
    "stablehlo.custom_call"(%90, %6) <{call_target_name = "check.expect_close", has_side_effect = true}> : (tensor<20x20xbf16>, tensor<20x20xbf16>) -> ()
    "func.return"(%90) : (tensor<20x20xbf16>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = () -> (tensor<20x20xbf16>, tensor<20x20xbf16>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %3 = "stablehlo.constant"() <{value = dense<""> : tensor<20x20xbf16>}> : () -> tensor<20x20xbf16>
    %4 = "stablehlo.constant"() <{value = dense<""> : tensor<20x20xbf16>}> : () -> tensor<20x20xbf16>
  ...
  "func.func"() <{function_type = () -> tensor<20x20xbf16>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %2 = "stablehlo.constant"() <{value = dense<""> : tensor<20x20xbf16>}> : () -> tensor<20x20xbf16>
