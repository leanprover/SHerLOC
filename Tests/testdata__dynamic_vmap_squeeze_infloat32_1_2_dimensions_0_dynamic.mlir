"builtin.module"() <{sym_name = "jit_fun_flat_jax"}> ({
  "func.func"() <{arg_attrs = [{}, {mhlo.sharding = ""}], function_type = (tensor<i64>, tensor<?x1x2xf32>) -> tensor<?x2xf32>, sym_name = "main", sym_visibility = "public"}> ({
  ^bb0(%arg0: tensor<i64>, %arg1: tensor<?x1x2xf32>):
    ...
    %4 = "stablehlo.dynamic_reshape"(%arg1, %3) : (tensor<?x1x2xf32>, tensor<2xi32>) -> tensor<?x2xf32>
