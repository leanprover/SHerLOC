"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "xor_op_test_si4"}> ({
    ...
    %2 = "stablehlo.xor"(%0, %1) : (tensor<3xi4>, tensor<3xi4>) -> tensor<3xi4>
    "check.expect_eq_const"(%2) <{value = dense<[7, -1, 0]> : tensor<3xi4>}> : (tensor<3xi4>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "xor_op_test_ui4"}> ({
    ...
    %2 = "stablehlo.xor"(%0, %1) : (tensor<3xui4>, tensor<3xui4>) -> tensor<3xui4>
    "check.expect_eq_const"(%2) <{value = dense<[15, 8, 0]> : tensor<3xui4>}> : (tensor<3xui4>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "xor_op_test_si8"}> ({
    ...
    %2 = "stablehlo.xor"(%0, %1) : (tensor<3xi8>, tensor<3xi8>) -> tensor<3xi8>
    "check.expect_eq_const"(%2) <{value = dense<[127, -1, 0]> : tensor<3xi8>}> : (tensor<3xi8>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "xor_op_test_ui8"}> ({
    ...
    %2 = "stablehlo.xor"(%0, %1) : (tensor<3xui8>, tensor<3xui8>) -> tensor<3xui8>
    "check.expect_eq_const"(%2) <{value = dense<[255, 128, 0]> : tensor<3xui8>}> : (tensor<3xui8>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "xor_op_test_si16"}> ({
    ...
    %2 = "stablehlo.xor"(%0, %1) : (tensor<3xi16>, tensor<3xi16>) -> tensor<3xi16>
    "check.expect_eq_const"(%2) <{value = dense<[32767, -1, 0]> : tensor<3xi16>}> : (tensor<3xi16>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "xor_op_test_ui16"}> ({
    ...
    %2 = "stablehlo.xor"(%0, %1) : (tensor<3xui16>, tensor<3xui16>) -> tensor<3xui16>
    "check.expect_eq_const"(%2) <{value = dense<[65535, 32768, 0]> : tensor<3xui16>}> : (tensor<3xui16>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "xor_op_test_si32"}> ({
    ...
    %2 = "stablehlo.xor"(%0, %1) : (tensor<3xi32>, tensor<3xi32>) -> tensor<3xi32>
    "check.expect_eq_const"(%2) <{value = dense<[2147483647, -1, 0]> : tensor<3xi32>}> : (tensor<3xi32>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "xor_op_test_ui32"}> ({
    ...
    %2 = "stablehlo.xor"(%0, %1) : (tensor<3xui32>, tensor<3xui32>) -> tensor<3xui32>
    "check.expect_eq_const"(%2) <{value = dense<[4294967295, 2147483648, 0]> : tensor<3xui32>}> : (tensor<3xui32>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "xor_op_test_si64"}> ({
    ...
    %2 = "stablehlo.xor"(%0, %1) : (tensor<3xi64>, tensor<3xi64>) -> tensor<3xi64>
    "check.expect_eq_const"(%2) <{value = dense<[9223372036854775807, -1, 0]> : tensor<3xi64>}> : (tensor<3xi64>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "xor_op_test_ui64"}> ({
    ...
    %2 = "stablehlo.xor"(%0, %1) : (tensor<3xui64>, tensor<3xui64>) -> tensor<3xui64>
    "check.expect_eq_const"(%2) <{value = dense<[18446744073709551615, 9223372036854775808, 0]> : tensor<3xui64>}> : (tensor<3xui64>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "xor_op_test_i1"}> ({
    ...
    %2 = "stablehlo.xor"(%0, %1) : (tensor<4xi1>, tensor<4xi1>) -> tensor<4xi1>
