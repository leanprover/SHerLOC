"builtin.module"() <{sym_name = "jit_main"}> ({
  "func.func"() <{function_type = () -> tensor<9xbf16>, res_attrs = [{jax.result_info = "", mhlo.layout_mode = "default"}], sym_name = "main", sym_visibility = "public"}> ({
    %50:3 = "func.call"() <{callee = @inputs}> : () -> (tensor<9xbf16>, tensor<9xbf16>, tensor<9xbf16>)
    %51 = "func.call"() <{callee = @expected}> : () -> tensor<9xbf16>
    %52 = "stablehlo.convert"(%50#0) : (tensor<9xbf16>) -> tensor<9xf32>
    %53 = "stablehlo.convert"(%50#1) : (tensor<9xbf16>) -> tensor<9xf32>
    %54 = "stablehlo.convert"(%50#2) : (tensor<9xbf16>) -> tensor<9xf32>
    ...
    %130 = "stablehlo.convert"(%129) : (tensor<9xf32>) -> tensor<9xbf16>
    "stablehlo.custom_call"(%130, %51) <{call_target_name = "check.expect_close", has_side_effect = true}> : (tensor<9xbf16>, tensor<9xbf16>) -> ()
    "func.return"(%130) : (tensor<9xbf16>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = () -> (tensor<9xbf16>, tensor<9xbf16>, tensor<9xbf16>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %47 = "stablehlo.constant"() <{value = dense<[-1.601560e+00, -1.398440e+00, -1.000000e+00, 0.000000e+00, 1.000980e-01, 3.007810e-01, 1.000000e+00, 1.398440e+00, 1.601560e+00]> : tensor<9xbf16>}> : () -> tensor<9xbf16>
    %48 = "stablehlo.constant"() <{value = dense<[-1.601560e+00, 1.398440e+00, 1.000000e+00, 0.000000e+00, 2.001950e-01, 1.000980e-01, 1.000000e+00, 1.398440e+00, -1.601560e+00]> : tensor<9xbf16>}> : () -> tensor<9xbf16>
    %49 = "stablehlo.constant"() <{value = dense<[1.000000e+00, -1.000000e+00, 2.000000e+00, 1.000000e+00, 3.007810e-01, 3.007810e-01, -1.000000e+00, 2.406250e+00, 1.601560e+00]> : tensor<9xbf16>}> : () -> tensor<9xbf16>
    "func.return"(%47, %48, %49) : (tensor<9xbf16>, tensor<9xbf16>, tensor<9xbf16>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = () -> tensor<9xbf16>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %46 = "stablehlo.constant"() <{value = dense<[0x7FC0, 0x7FC0, 0x7FC0, 0x7FC0, 6.210940e-01, 1.943360e-01, 0x7FC0, 0x7FC0, 0x7FC0]> : tensor<9xbf16>}> : () -> tensor<9xbf16>
    "func.return"(%46) : (tensor<9xbf16>) -> ()
  }) : () -> ()
