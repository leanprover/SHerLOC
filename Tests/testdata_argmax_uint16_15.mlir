"builtin.module"() <{sym_name = "jit_main"}> ({
  "func.func"() <{function_type = () -> tensor<i32>, res_attrs = [{jax.result_info = "", mhlo.layout_mode = "default"}], sym_name = "main", sym_visibility = "public"}> ({
    ...
    %17 = "func.call"(%15) <{callee = @argmax}> : (tensor<15xui16>) -> tensor<i32>
  ...
  "func.func"() <{function_type = () -> tensor<15xui16>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %14 = "stablehlo.constant"() <{value = dense<[2, 1, 3, 1, 0, 7, 3, 1, 2, 5, 3, 4, 2, 0, 8]> : tensor<15xui16>}> : () -> tensor<15xui16>
  ...
  "func.func"() <{function_type = (tensor<15xui16>) -> tensor<i32>, sym_name = "argmax", sym_visibility = "private"}> ({
  ^bb0(%arg0: tensor<15xui16>):
    ...
    ^bb0(%arg1: tensor<ui16>, %arg2: tensor<i32>, %arg3: tensor<ui16>, %arg4: tensor<i32>):
      %4 = "stablehlo.compare"(%arg1, %arg3) <{compare_type = #stablehlo<comparison_type UNSIGNED>, comparison_direction = #stablehlo<comparison_direction GT>}> : (tensor<ui16>, tensor<ui16>) -> tensor<i1>
