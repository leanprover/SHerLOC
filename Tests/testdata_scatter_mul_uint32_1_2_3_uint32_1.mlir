"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<1x2x3xui32>, tensor<1xui32>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[3, 1, 4], [4, 2, 2]]]> : tensor<1x2x3xui32>}> : () -> tensor<1x2x3xui32>
  ...
  "func.func"() <{function_type = () -> tensor<1x2x3xui32>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[3, 1, 4], [4, 2, 2]]]> : tensor<1x2x3xui32>}> : () -> tensor<1x2x3xui32>
