"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<1x5xf32>, tensor<1xf32>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[-1.21055615, 1.33402717, -4.02992582, -2.01758671, -0.116875052]]> : tensor<1x5xf32>}> : () -> tensor<1x5xf32>
    %2 = "stablehlo.constant"() <{value = dense<3.40705895> : tensor<1xf32>}> : () -> tensor<1xf32>
  ...
  "func.func"() <{function_type = () -> tensor<1x5xf32>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[-1.21055615, 1.33402717, -4.02992582, -2.01758671, -0.116875052]]> : tensor<1x5xf32>}> : () -> tensor<1x5xf32>
