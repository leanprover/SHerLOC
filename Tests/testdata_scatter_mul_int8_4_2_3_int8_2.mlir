"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<4x2x3xi8>, tensor<2xi8>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[0, 0, 3], [0, -2, -4]], [[-2, 1, 2], [-1, 1, -1]], [[1, -2, 1], [0, -4, 2]], [[-5, 2, -3], [0, 0, 3]]]> : tensor<4x2x3xi8>}> : () -> tensor<4x2x3xi8>
    %2 = "stablehlo.constant"() <{value = dense<[-1, 2]> : tensor<2xi8>}> : () -> tensor<2xi8>
  ...
  "func.func"() <{function_type = () -> tensor<4x2x3xi8>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[0, 0, 3], [0, -2, -4]], [[-2, 1, 2], [-1, 1, -1]], [[1, -2, 1], [0, -4, 2]], [[-5, 2, 3], [0, 0, 6]]]> : tensor<4x2x3xi8>}> : () -> tensor<4x2x3xi8>
