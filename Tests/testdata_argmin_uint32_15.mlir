"builtin.module"() <{sym_name = "jit_main"}> ({
  "func.func"() <{function_type = () -> tensor<i32>, res_attrs = [{jax.result_info = "", mhlo.layout_mode = "default"}], sym_name = "main", sym_visibility = "public"}> ({
    ...
    %17 = "func.call"(%15) <{callee = @argmin}> : (tensor<15xui32>) -> tensor<i32>
  ...
  "func.func"() <{function_type = () -> tensor<15xui32>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %14 = "stablehlo.constant"() <{value = dense<[1, 2, 2, 4, 5, 2, 4, 4, 3, 3, 0, 2, 4, 2, 0]> : tensor<15xui32>}> : () -> tensor<15xui32>
  ...
  "func.func"() <{function_type = (tensor<15xui32>) -> tensor<i32>, sym_name = "argmin", sym_visibility = "private"}> ({
  ^bb0(%arg0: tensor<15xui32>):
    %0 = "stablehlo.iota"() <{iota_dimension = 0 : i64}> : () -> tensor<15xi32>
    %1 = "stablehlo.constant"() <{value = dense<4294967295> : tensor<ui32>}> : () -> tensor<ui32>
    ...
    ^bb0(%arg1: tensor<ui32>, %arg2: tensor<i32>, %arg3: tensor<ui32>, %arg4: tensor<i32>):
      %4 = "stablehlo.compare"(%arg1, %arg3) <{compare_type = #stablehlo<comparison_type UNSIGNED>, comparison_direction = #stablehlo<comparison_direction LT>}> : (tensor<ui32>, tensor<ui32>) -> tensor<i1>
