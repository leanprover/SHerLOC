"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> tensor<8x9xf32>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %3 = "stablehlo.constant"() <{value = dense<[[-6.37931442, 1567.89319, -4.39815378, -8318.81445, -708.033875, 1824.43738, -404.531555, -770.459167, 103.698654], [1.56836748, -309.607697, -1.45725787, 1569.93896, 270.103149, -547.133484, 168.508209, 331.228363, -25.0021915], [-1.09664214, -100.959854, -0.235917732, -401.104156, -56.6746712, 249.792053, -83.2621689, -6.445650e+02, -15.997963], [-1.61642718, -90.0260467, 0.140458778, 226.910446, -12.8387232, 79.6443634, 44.2619209, 423.85791, -8.3641386], [-0.981369495, -43.3396683, -0.204885796, 124.982376, -16.6440754, 46.7441521, 6.84595108, 113.947853, -65.81221], [0.309769899, -10.9233513, -0.0559106134, 40.8281326, -13.3375874, -13.7182808, -1.08161128, 26.3377113, 86.2491531], [-1.09457564, 22.7086658, 0.0432857275, -1.965870e+01, -6.79948664, 5.98053836, 0.321455091, 8.60381412, 11.0303335], [3.49141359, -1.65513265, -0.885981321, 5.56268597, -4.8591814, 1.7360673, -2.22915959, 0.980064034, 3.10066438]]> : tensor<8x9xf32>}> : () -> tensor<8x9xf32>
    "func.return"(%3) : (tensor<8x9xf32>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = (tensor<8x9xf32>) -> tensor<8x9xf32>, sym_name = "cumprod", sym_visibility = "private"}> ({
  ^bb0(%arg0: tensor<8x9xf32>):
    %0 = "stablehlo.constant"() <{value = dense<1.000000e+00> : tensor<f32>}> : () -> tensor<f32>
    %1 = "stablehlo.reduce_window"(%arg0, %0) <{padding = dense<[[0, 7], [0, 0]]> : tensor<2x2xi64>, window_dimensions = array<i64: 8, 1>}> ({
    ^bb0(%arg1: tensor<f32>, %arg2: tensor<f32>):
      %2 = "stablehlo.multiply"(%arg1, %arg2) : (tensor<f32>, tensor<f32>) -> tensor<f32>
      "stablehlo.return"(%2) : (tensor<f32>) -> ()
    }) : (tensor<8x9xf32>, tensor<f32>) -> tensor<8x9xf32>
    "func.return"(%1) : (tensor<8x9xf32>) -> ()
  }) : () -> ()
