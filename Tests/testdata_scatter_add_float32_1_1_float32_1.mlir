"builtin.module"() <{sym_name = "jit_main"}> ({
  "func.func"() <{function_type = () -> tensor<1x1xf32>, res_attrs = [{jax.result_info = "", mhlo.layout_mode = "default"}], sym_name = "main", sym_visibility = "public"}> ({
    ...
    %4:2 = "func.call"() <{callee = @inputs}> : () -> (tensor<1x1xf32>, tensor<1xf32>)
    %5 = "func.call"() <{callee = @expected}> : () -> tensor<1x1xf32>
    ...
    "stablehlo.custom_call"(%6, %5) <{call_target_name = "check.expect_close", has_side_effect = true}> : (tensor<1x1xf32>, tensor<1x1xf32>) -> ()
    "func.return"(%6) : (tensor<1x1xf32>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = () -> (tensor<1x1xf32>, tensor<1xf32>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<0.200348631> : tensor<1x1xf32>}> : () -> tensor<1x1xf32>
    %2 = "stablehlo.constant"() <{value = dense<2.59989643> : tensor<1xf32>}> : () -> tensor<1xf32>
    "func.return"(%1, %2) : (tensor<1x1xf32>, tensor<1xf32>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = () -> tensor<1x1xf32>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<2.80024505> : tensor<1x1xf32>}> : () -> tensor<1x1xf32>
