"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<1x2x3xf32>, tensor<1x3xf32>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[-0.634385168, 1.32585716, -1.88348019], [-4.157850e+00, 4.68038845, 0.182416499]]]> : tensor<1x2x3xf32>}> : () -> tensor<1x2x3xf32>
    %2 = "stablehlo.constant"() <{value = dense<[[-0.401516825, 5.856480e-01, -1.54223073]]> : tensor<1x3xf32>}> : () -> tensor<1x3xf32>
  ...
  "func.func"() <{function_type = () -> tensor<1x2x3xf32>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[-0.634385168, 1.32585716, -1.88348019], [-4.5593667, 5.26603651, -1.35981417]]]> : tensor<1x2x3xf32>}> : () -> tensor<1x2x3xf32>
