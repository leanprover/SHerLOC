"builtin.module"() <{sym_name = "jit_fun_flat_jax"}> ({
  "func.func"() <{arg_attrs = [{}, {mhlo.sharding = ""}], function_type = (tensor<i64>, tensor<?x4x5xf32>) -> tensor<4x5xi32>, sym_name = "main", sym_visibility = "public"}> ({
  ^bb0(%arg6: tensor<i64>, %arg7: tensor<?x4x5xf32>):
    %18 = "func.call"(%arg6, %arg7) <{callee = @argmax}> : (tensor<i64>, tensor<?x4x5xf32>) -> tensor<4x5xi32>
    "func.return"(%18) : (tensor<4x5xi32>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = (tensor<i64>, tensor<?x4x5xf32>) -> tensor<4x5xi32>, sym_name = "argmax", sym_visibility = "private"}> ({
  ^bb0(%arg0: tensor<i64>, %arg1: tensor<?x4x5xf32>):
    ...
    %5 = "stablehlo.dynamic_iota"(%4) <{iota_dimension = 0 : i64}> : (tensor<3xi32>) -> tensor<?x4x5xi32>
    ...
    %8:2 = "stablehlo.reduce"(%arg1, %5, %6, %7) <{dimensions = array<i64: 0>}> ({
    ...
    }) : (tensor<?x4x5xf32>, tensor<?x4x5xi32>, tensor<f32>, tensor<i32>) -> (tensor<4x5xf32>, tensor<4x5xi32>)
    "func.return"(%8#1) : (tensor<4x5xi32>) -> ()
  }) : () -> ()
}) : () -> ()
