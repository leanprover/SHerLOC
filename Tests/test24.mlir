"builtin.module"() <{sym_name = "jit_f"}> ({
  "func.func"() <{function_type = () -> (tensor<i32>, tensor<f32>, tensor<i1>), res_attrs = [{jax.result_info = "[0]", mhlo.layout_mode = "default"}, {jax.result_info = "[1]", mhlo.layout_mode = "default"}, {jax.result_info = "[2]", mhlo.layout_mode = "default"}], sym_name = "main", sym_visibility = "public"}> ({
    ...
    "func.return"(%0, %1, %2) : (tensor<i32>, tensor<f32>, tensor<i1>) -> ()
  }) : () -> ()
