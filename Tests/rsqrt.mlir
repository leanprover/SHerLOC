"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "rsqrt_op_test_f64"}> ({
    %2 = "stablehlo.constant"() <{value = dense<[[1.000000e+00, 4.000000e+00], [9.000000e+00, 2.500000e+01]]> : tensor<2x2xf64>}> : () -> tensor<2x2xf64>
    %3 = "stablehlo.rsqrt"(%2) : (tensor<2x2xf64>) -> tensor<2x2xf64>
    "check.expect_almost_eq_const"(%3) <{value = dense<[[1.000000e+00, 5.000000e-01], [0.33333333333333331, 2.000000e-01]]> : tensor<2x2xf64>}> : (tensor<2x2xf64>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
