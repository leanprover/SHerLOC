"builtin.module"() <{sym_name = "jit_fun_flat_jax"}> ({
  "func.func"() <{arg_attrs = [{}, {mhlo.sharding = ""}], function_type = (tensor<i64>, tensor<?x1x2xf32>) -> tensor<?x4x3x2xf32>, sym_name = "main", sym_visibility = "public"}> ({
  ^bb0(%arg0: tensor<i64>, %arg1: tensor<?x1x2xf32>):
    ...
    %6 = "stablehlo.dynamic_broadcast_in_dim"(%arg1, %5) <{broadcast_dimensions = array<i64: 0, 1, 3>}> : (tensor<?x1x2xf32>, tensor<4xi32>) -> tensor<?x4x3x2xf32>
    "func.return"(%6) : (tensor<?x4x3x2xf32>) -> ()
  }) : () -> ()
}) : () -> ()
