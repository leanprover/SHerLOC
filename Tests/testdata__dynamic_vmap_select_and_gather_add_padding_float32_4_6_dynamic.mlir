"builtin.module"() <{sym_name = "jit_fun_flat_jax"}> ({
  "func.func"() <{arg_attrs = [{}, {mhlo.sharding = ""}, {mhlo.sharding = ""}], function_type = (tensor<i64>, tensor<?x4x6xf32>, tensor<?x4x6xf32>) -> tensor<?x4x6xf32>, sym_name = "main", sym_visibility = "public"}> ({
  ^bb0(%arg0: tensor<i64>, %arg1: tensor<?x4x6xf32>, %arg2: tensor<?x4x6xf32>):
    ...
    %2:2 = "stablehlo.reduce_window"(%arg2, %arg1, %0, %1) <{padding = dense<[[0, 0], [0, 1], [0, 1]]> : tensor<3x2xi64>, window_dimensions = array<i64: 1, 2, 2>}> ({
    ...
    }) : (tensor<?x4x6xf32>, tensor<?x4x6xf32>, tensor<f32>, tensor<f32>) -> (tensor<?x4x6xf32>, tensor<?x4x6xf32>)
    "func.return"(%2#1) : (tensor<?x4x6xf32>) -> ()
  }) : () -> ()
}) : () -> ()
