"builtin.module"() <{sym_name = "jit_main"}> ({
  "func.func"() <{function_type = () -> tensor<3x3xcomplex<f64>>, res_attrs = [{jax.result_info = "", mhlo.layout_mode = "default"}], sym_name = "main", sym_visibility = "public"}> ({
    ...
    %8 = "stablehlo.compare"(%5, %6) <{compare_type = #stablehlo<comparison_type FLOAT>, comparison_direction = #stablehlo<comparison_direction LT>}> : (tensor<3x3xf64>, tensor<3x3xf64>) -> tensor<3x3xi1>
    %9 = "stablehlo.imag"(%3#0) : (tensor<3x3xcomplex<f64>>) -> tensor<3x3xf64>
    %10 = "stablehlo.imag"(%3#1) : (tensor<3x3xcomplex<f64>>) -> tensor<3x3xf64>
    %11 = "stablehlo.compare"(%9, %10) <{compare_type = #stablehlo<comparison_type FLOAT>, comparison_direction = #stablehlo<comparison_direction LT>}> : (tensor<3x3xf64>, tensor<3x3xf64>) -> tensor<3x3xi1>
  ...
  "func.func"() <{function_type = () -> tensor<3x3xcomplex<f64>>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[(0x7FF8000000000000,0.000000e+00), (0x7FF0000000000000,0.000000e+00), (0xFFF0000000000000,0.000000e+00)], [(0x7FF8000000000000,0.000000e+00), (0x7FF0000000000000,0.000000e+00), (0xFFF0000000000000,0.000000e+00)], [(0x7FF8000000000000,0.000000e+00), (0xFFF0000000000000,0.000000e+00), (0xFFF0000000000000,0.000000e+00)]]> : tensor<3x3xcomplex<f64>>}> : () -> tensor<3x3xcomplex<f64>>
