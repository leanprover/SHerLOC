"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<3xf64>, tensor<3xf64>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[-3.1606803859059385, -2.1021573784074277, 0.70113726658541053]> : tensor<3xf64>}> : () -> tensor<3xf64>
    %2 = "stablehlo.constant"() <{value = dense<[2.2532707502232001, 0.7952206623213286, 1.187969274625182]> : tensor<3xf64>}> : () -> tensor<3xf64>
  ...
  "func.func"() <{function_type = () -> tensor<3xf64>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[0.7952206623213286, 2.2532707502232001, 0.70113726658541053]> : tensor<3xf64>}> : () -> tensor<3xf64>
