"builtin.module"() <{sym_name = "jit_fun_flat_jax"}> ({
  ...
  ^bb0(%arg6: tensor<i64>, %arg7: tensor<?x18x12xf32>):
    %18 = "func.call"(%arg6, %arg7) <{callee = @argmax}> : (tensor<i64>, tensor<?x18x12xf32>) -> tensor<?x18xi32>
    "func.return"(%18) : (tensor<?x18xi32>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = (tensor<i64>, tensor<?x18x12xf32>) -> tensor<?x18xi32>, sym_name = "argmax", sym_visibility = "private"}> ({
