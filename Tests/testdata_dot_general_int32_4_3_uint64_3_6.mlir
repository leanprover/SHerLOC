"builtin.module"() <{sym_name = "jit_main"}> ({
  "func.func"() <{function_type = () -> tensor<4x6xui64>, res_attrs = [{jax.result_info = "", mhlo.layout_mode = "default"}], sym_name = "main", sym_visibility = "public"}> ({
    %3:2 = "func.call"() <{callee = @inputs}> : () -> (tensor<4x3xi32>, tensor<3x6xui64>)
    %4 = "func.call"() <{callee = @expected}> : () -> tensor<4x6xui64>
    %5 = "stablehlo.convert"(%3#0) : (tensor<4x3xi32>) -> tensor<4x3xui64>
  ...
  "func.func"() <{function_type = () -> (tensor<4x3xi32>, tensor<3x6xui64>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[3, 5, 0], [3, 1, -5], [5, -2, -1], [0, -7, 1]]> : tensor<4x3xi32>}> : () -> tensor<4x3xi32>
    %2 = "stablehlo.constant"() <{value = dense<[[1, 2, 0, 1, 1, 2], [3, 3, 3, 0, 5, 4], [6, 0, 2, 1, 6, 5]]> : tensor<3x6xui64>}> : () -> tensor<3x6xui64>
    "func.return"(%1, %2) : (tensor<4x3xi32>, tensor<3x6xui64>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = () -> tensor<4x6xui64>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[18, 21, 15, 3, 28, 26], [18446744073709551592, 9, 18446744073709551609, 18446744073709551614, 18446744073709551594, 18446744073709551601], [18446744073709551609, 4, 18446744073709551608, 4, 18446744073709551605, 18446744073709551613], [18446744073709551601, 18446744073709551595, 18446744073709551597, 1, 18446744073709551587, 18446744073709551593]]> : tensor<4x6xui64>}> : () -> tensor<4x6xui64>
