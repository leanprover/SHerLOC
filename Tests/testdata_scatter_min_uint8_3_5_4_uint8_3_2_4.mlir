"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<3x5x4xui8>, tensor<3x2x4xui8>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[2, 2, 0, 1], [1, 1, 4, 2], [0, 5, 3, 2], [3, 3, 0, 0], [1, 4, 4, 3]], [[5, 3, 0, 1], [0, 1, 1, 3], [0, 4, 2, 0], [2, 0, 0, 0], [1, 3, 1, 10]], [[2, 5, 3, 1], [1, 2, 1, 0], [1, 2, 0, 2], [5, 1, 0, 0], [2, 0, 3, 4]]]> : tensor<3x5x4xui8>}> : () -> tensor<3x5x4xui8>
    %2 = "stablehlo.constant"() <{value = dense<[[[5, 2, 3, 1], [7, 1, 0, 3]], [[1, 1, 1, 1], [4, 1, 2, 3]], [[3, 3, 1, 1], [0, 1, 4, 3]]]> : tensor<3x2x4xui8>}> : () -> tensor<3x2x4xui8>
  ...
  "func.func"() <{function_type = () -> tensor<3x5x4xui8>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[2, 2, 0, 1], [1, 1, 0, 1], [0, 5, 3, 2], [3, 3, 0, 0], [1, 4, 4, 3]], [[5, 3, 0, 1], [0, 1, 1, 1], [0, 4, 2, 0], [2, 0, 0, 0], [1, 3, 1, 10]], [[2, 5, 3, 1], [0, 1, 1, 0], [1, 2, 0, 2], [5, 1, 0, 0], [2, 0, 3, 4]]]> : tensor<3x5x4xui8>}> : () -> tensor<3x5x4xui8>
