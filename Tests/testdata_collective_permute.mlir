"builtin.module"() <{sym_name = "cross_replica"}> ({
  ...
  ^bb0(%arg0: tensor<2x2xi64>):
    %4 = "stablehlo.collective_permute"(%arg0) <{channel_handle = #stablehlo.channel_handle<handle = 0, type = 0>, source_target_pairs = dense<[[0, 1], [1, 2]]> : tensor<2x2xi64>}> : (tensor<2x2xi64>) -> tensor<2x2xi64>
