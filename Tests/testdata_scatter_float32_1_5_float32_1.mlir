"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<1x5xf32>, tensor<1xf32>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[0.647725999, -0.830481529, 1.42176676, -1.57369435, 3.30237603]]> : tensor<1x5xf32>}> : () -> tensor<1x5xf32>
    %2 = "stablehlo.constant"() <{value = dense<3.14684749> : tensor<1xf32>}> : () -> tensor<1xf32>
  ...
  "func.func"() <{function_type = () -> tensor<1x5xf32>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[0.647725999, -0.830481529, 1.42176676, -1.57369435, 3.30237603]]> : tensor<1x5xf32>}> : () -> tensor<1x5xf32>
