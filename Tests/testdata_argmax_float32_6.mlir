"builtin.module"() <{sym_name = "jit_main"}> ({
  "func.func"() <{function_type = () -> tensor<i32>, res_attrs = [{jax.result_info = "", mhlo.layout_mode = "default"}], sym_name = "main", sym_visibility = "public"}> ({
    %15 = "func.call"() <{callee = @inputs}> : () -> tensor<6xf32>
    %16 = "func.call"() <{callee = @expected}> : () -> tensor<i32>
    %17 = "func.call"(%15) <{callee = @argmax}> : (tensor<6xf32>) -> tensor<i32>
  ...
  "func.func"() <{function_type = () -> tensor<6xf32>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %14 = "stablehlo.constant"() <{value = dense<[0x7FC00000, 0x7FC00000, 2.000000e+00, -2.000000e+00, 0xFFC00000, 0xFFC00000]> : tensor<6xf32>}> : () -> tensor<6xf32>
    "func.return"(%14) : (tensor<6xf32>) -> ()
  }) : () -> ()
  ...
  "func.func"() <{function_type = (tensor<6xf32>) -> tensor<i32>, sym_name = "argmax", sym_visibility = "private"}> ({
  ^bb0(%arg0: tensor<6xf32>):
    ...
    }) : (tensor<6xf32>, tensor<6xi32>, tensor<f32>, tensor<i32>) -> (tensor<f32>, tensor<i32>)
