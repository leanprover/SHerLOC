"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<4x2x3xui16>, tensor<2xui16>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[1, 1, 2], [3, 7, 2]], [[2, 2, 0], [4, 2, 2]], [[0, 0, 0], [0, 0, 0]], [[0, 2, 1], [5, 0, 1]]]> : tensor<4x2x3xui16>}> : () -> tensor<4x2x3xui16>
    %2 = "stablehlo.constant"() <{value = dense<[1, 0]> : tensor<2xui16>}> : () -> tensor<2xui16>
  ...
  "func.func"() <{function_type = () -> tensor<4x2x3xui16>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[1, 1, 2], [3, 7, 2]], [[2, 2, 0], [4, 2, 2]], [[0, 0, 0], [0, 0, 0]], [[0, 2, 1], [5, 0, 0]]]> : tensor<4x2x3xui16>}> : () -> tensor<4x2x3xui16>
