"builtin.module"() <{sym_name = "jit_fun_flat_jax"}> ({
  "func.func"() <{arg_attrs = [{}, {mhlo.sharding = ""}, {mhlo.sharding = ""}], function_type = (tensor<i64>, tensor<?x10xf32>, tensor<?x3x1xi64>) -> tensor<?x3x2xf32>, sym_name = "main", sym_visibility = "public"}> ({
  ^bb0(%arg0: tensor<i64>, %arg1: tensor<?x10xf32>, %arg2: tensor<?x3x1xi64>):
    ...
    %5 = "stablehlo.dynamic_iota"(%4) <{iota_dimension = 0 : i64}> : (tensor<3xi32>) -> tensor<?x3x1xi64>
    %6 = "stablehlo.concatenate"(%5, %arg2) <{dimension = 2 : i64}> : (tensor<?x3x1xi64>, tensor<?x3x1xi64>) -> tensor<?x3x2xi64>
