"builtin.module"() <{sym_name = "jit_fun_flat_jax"}> ({
  ...
  ^bb0(%arg0: tensor<i64>, %arg1: tensor<?x4xf32>):
    ...
    %14 = "stablehlo.constant"() <{value = dense<2> : tensor<1xi32>}> : () -> tensor<1xi32>
    ...
    %20 = "stablehlo.real_dynamic_slice"(%arg1, %6, %16, %19) : (tensor<?x4xf32>, tensor<2xi32>, tensor<2xi32>, tensor<2xi32>) -> tensor<?x2xf32>
    "func.return"(%20) : (tensor<?x2xf32>) -> ()
  }) : () -> ()
}) : () -> ()
