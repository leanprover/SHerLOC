"builtin.module"() <{sym_name = "jit_main"}> ({
  "func.func"() <{function_type = () -> tensor<4x6xcomplex<f64>>, res_attrs = [{jax.result_info = "", mhlo.layout_mode = "default"}], sym_name = "main", sym_visibility = "public"}> ({
    %3:2 = "func.call"() <{callee = @inputs}> : () -> (tensor<4x3xf64>, tensor<3x6xcomplex<f64>>)
    %4 = "func.call"() <{callee = @expected}> : () -> tensor<4x6xcomplex<f64>>
    %5 = "stablehlo.convert"(%3#0) : (tensor<4x3xf64>) -> tensor<4x3xcomplex<f64>>
  ...
  "func.func"() <{function_type = () -> (tensor<4x3xf64>, tensor<3x6xcomplex<f64>>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[-0.89825024827570332, -2.5245810254908507, 5.164459648018755], [-1.0527164587586098, 2.8261515069750081, 1.6466189692855533], [4.0548074629035646, -3.9451701219106496, 6.7099504551770481], [1.0058345677341527, -1.1133009380872523, 2.8242823678082201]]> : tensor<4x3xf64>}> : () -> tensor<4x3xf64>
    %2 = "stablehlo.constant"() <{value = dense<[[(0.44007951419621261,-0.14329354506260919), (5.0993573998546751,1.4378938233300973), (2.4588540250673998,5.1754074173983362), (0.46592987296609262,-6.0932013151388791), (1.0655352593954197,0.87226311791448785), (0.58355272758396648,-0.19714935656454236)], [(-1.04687259017969,-0.91787269610492894), (3.5640839991092026,-0.79015195241089619), (2.0945743212848384,-0.42830492452823948), (-0.072957280957986301,-1.3987085516093674), (-3.5412075747713567,0.1710076155424799), (-3.5022141354692624,2.2235395410375838)], [(4.2160429330294384,0.093532136341324206), (-2.0935815024107187,-4.3369883372582558), (-3.119059557090667,0.32419676957804811), (1.5303319695030149,5.0752499966244127), (-5.6309159035205116,2.4565008106047319), (-3.8369417021048684,-0.9207598518880229)]]> : tensor<3x6xcomplex<f64>>}> : () -> tensor<3x6xcomplex<f64>>
    "func.return"(%1, %2) : (tensor<4x3xf64>, tensor<3x6xcomplex<f64>>) -> ()
  }) : () -> ()
