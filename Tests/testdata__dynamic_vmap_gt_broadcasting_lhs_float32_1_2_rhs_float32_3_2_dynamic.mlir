"builtin.module"() <{sym_name = "jit_fun_flat_jax"}> ({
  ...
  ^bb0(%arg0: tensor<i64>, %arg1: tensor<?x1x2xf32>, %arg2: tensor<?x3x2xf32>):
    ...
    %6 = "stablehlo.compare"(%5, %arg2) <{compare_type = #stablehlo<comparison_type FLOAT>, comparison_direction = #stablehlo<comparison_direction GT>}> : (tensor<?x3x2xf32>, tensor<?x3x2xf32>) -> tensor<?x3x2xi1>
