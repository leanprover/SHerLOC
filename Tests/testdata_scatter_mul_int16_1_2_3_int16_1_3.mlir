"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<1x2x3xi16>, tensor<1x3xi16>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[-1, -1, 3], [-4, 1, 0]]]> : tensor<1x2x3xi16>}> : () -> tensor<1x2x3xi16>
    %2 = "stablehlo.constant"() <{value = dense<[[0, -1, 1]]> : tensor<1x3xi16>}> : () -> tensor<1x3xi16>
  ...
  "func.func"() <{function_type = () -> tensor<1x2x3xi16>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[-1, -1, 3], [0, -1, 0]]]> : tensor<1x2x3xi16>}> : () -> tensor<1x2x3xi16>
