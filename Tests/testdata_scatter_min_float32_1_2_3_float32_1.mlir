"builtin.module"() <{sym_name = "jit_main"}> ({
  "func.func"() <{function_type = () -> tensor<1x2x3xf32>, res_attrs = [{jax.result_info = "", mhlo.layout_mode = "default"}], sym_name = "main", sym_visibility = "public"}> ({
    ...
    %4:2 = "func.call"() <{callee = @inputs}> : () -> (tensor<1x2x3xf32>, tensor<1xf32>)
  ...
  "func.func"() <{function_type = () -> (tensor<1x2x3xf32>, tensor<1xf32>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[1.37975812, 4.28310537, 0.578301907], [2.74615192, 3.62372589, -1.18187666]]]> : tensor<1x2x3xf32>}> : () -> tensor<1x2x3xf32>
    %2 = "stablehlo.constant"() <{value = dense<2.05577707> : tensor<1xf32>}> : () -> tensor<1xf32>
    "func.return"(%1, %2) : (tensor<1x2x3xf32>, tensor<1xf32>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = () -> tensor<1x2x3xf32>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[1.37975812, 4.28310537, 0.578301907], [2.74615192, 3.62372589, -1.18187666]]]> : tensor<1x2x3xf32>}> : () -> tensor<1x2x3xf32>
