"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<4x2x3xi16>, tensor<2xi16>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[0, -6, -3], [-4, -1, -1]], [[3, 3, 3], [3, 5, -1]], [[-1, 2, 4], [1, -3, -2]], [[0, 0, 0], [3, 2, 3]]]> : tensor<4x2x3xi16>}> : () -> tensor<4x2x3xi16>
    %2 = "stablehlo.constant"() <{value = dense<[-1, 1]> : tensor<2xi16>}> : () -> tensor<2xi16>
  ...
  "func.func"() <{function_type = () -> tensor<4x2x3xi16>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[0, -6, -3], [-4, -1, -1]], [[3, 3, 3], [3, 5, -1]], [[-1, 2, 4], [1, -3, -2]], [[0, 0, -1], [3, 2, 4]]]> : tensor<4x2x3xi16>}> : () -> tensor<4x2x3xi16>
