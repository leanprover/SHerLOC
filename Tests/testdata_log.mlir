"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "log_op_test_f64"}> ({
    ...
    %1 = "stablehlo.log"(%0) : (tensor<2x2xf64>) -> tensor<2x2xf64>
    "check.expect_almost_eq_const"(%1) <{value = dense<[[0.000000e+00, 0.69314718055994529], [1.0986122886681098, 1.3862943611198906]]> : tensor<2x2xf64>}> : (tensor<2x2xf64>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
