"builtin.module"() <{sym_name = "jit_main"}> ({
  "func.func"() <{function_type = () -> tensor<3xf64>, res_attrs = [{jax.result_info = "", mhlo.layout_mode = "default"}], sym_name = "main", sym_visibility = "public"}> ({
    %530 = "func.call"() <{callee = @inputs}> : () -> tensor<3xf64>
    %531 = "func.call"() <{callee = @expected}> : () -> tensor<3xf64>
    %532 = "func.call"(%530) <{callee = @"<lambda>"}> : (tensor<3xf64>) -> tensor<3xf64>
    "stablehlo.custom_call"(%532, %531) <{call_target_name = "check.expect_close", has_side_effect = true}> : (tensor<3xf64>, tensor<3xf64>) -> ()
    "func.return"(%532) : (tensor<3xf64>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = () -> tensor<3xf64>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %529 = "stablehlo.constant"() <{value = dense<[0.32999282409059688, 1.4493585479954081, 0.92543991796645963]> : tensor<3xf64>}> : () -> tensor<3xf64>
    "func.return"(%529) : (tensor<3xf64>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = () -> tensor<3xf64>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %528 = "stablehlo.constant"() <{value = dense<[0.0044547647687970997, 0.44586786372521875, 0.18356156921483407]> : tensor<3xf64>}> : () -> tensor<3xf64>
    "func.return"(%528) : (tensor<3xf64>) -> ()
  }) : () -> ()
  "func.func"() <{arg_attrs = [{mhlo.layout_mode = "default"}], function_type = (tensor<3xf64>) -> tensor<3xf64>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "<lambda>", sym_visibility = "private"}> ({
  ^bb0(%arg165: tensor<3xf64>):
    %516 = "stablehlo.constant"() <{value = dense<42> : tensor<i64>}> : () -> tensor<i64>
    %517 = "stablehlo.constant"() <{value = dense<32> : tensor<i64>}> : () -> tensor<i64>
    %518 = "stablehlo.shift_right_logical"(%516, %517) : (tensor<i64>, tensor<i64>) -> tensor<i64>
    %519 = "stablehlo.convert"(%518) : (tensor<i64>) -> tensor<ui32>
    %520 = "stablehlo.broadcast_in_dim"(%519) <{broadcast_dimensions = array<i64>}> : (tensor<ui32>) -> tensor<1xui32>
    %521 = "stablehlo.constant"() <{value = dense<4294967295> : tensor<ui32>}> : () -> tensor<ui32>
    %522 = "stablehlo.convert"(%521) : (tensor<ui32>) -> tensor<i64>
    %523 = "stablehlo.and"(%516, %522) : (tensor<i64>, tensor<i64>) -> tensor<i64>
    %524 = "stablehlo.convert"(%523) : (tensor<i64>) -> tensor<ui32>
    %525 = "stablehlo.broadcast_in_dim"(%524) <{broadcast_dimensions = array<i64>}> : (tensor<ui32>) -> tensor<1xui32>
    %526 = "stablehlo.concatenate"(%520, %525) <{dimension = 0 : i64}> : (tensor<1xui32>, tensor<1xui32>) -> tensor<2xui32>
    %527 = "func.call"(%526, %arg165) <{callee = @_gamma}> : (tensor<2xui32>, tensor<3xf64>) -> tensor<3xf64>
    "func.return"(%527) : (tensor<3xf64>) -> ()
  }) : () -> ()
  "func.func"() <{arg_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], function_type = (tensor<2xui32>, tensor<3xf64>) -> tensor<3xf64>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "_gamma", sym_visibility = "private"}> ({
  ^bb0(%arg155: tensor<2xui32>, %arg156: tensor<3xf64>):
    %479 = "stablehlo.reshape"(%arg155) : (tensor<2xui32>) -> tensor<1x2xui32>
    %480 = "func.call"(%479) <{callee = @_threefry_split}> : (tensor<1x2xui32>) -> tensor<1x3x2xui32>
    %481 = "stablehlo.reshape"(%480) : (tensor<1x3x2xui32>) -> tensor<3x2xui32>
    %482 = "stablehlo.constant"() <{value = dense<0.000000e+00> : tensor<f64>}> : () -> tensor<f64>
    %483 = "stablehlo.broadcast_in_dim"(%482) <{broadcast_dimensions = array<i64>}> : (tensor<f64>) -> tensor<3xf64>
    %484 = "stablehlo.constant"() <{value = dense<0> : tensor<i64>}> : () -> tensor<i64>
    %485:4 = "stablehlo.while"(%481, %arg156, %484, %483) ({
    ^bb0(%arg161: tensor<3x2xui32>, %arg162: tensor<3xf64>, %arg163: tensor<i64>, %arg164: tensor<3xf64>):
      %514 = "stablehlo.constant"() <{value = dense<3> : tensor<i64>}> : () -> tensor<i64>
      %515 = "stablehlo.compare"(%arg163, %514) <{compare_type = #stablehlo<comparison_type SIGNED>, comparison_direction = #stablehlo<comparison_direction LT>}> : (tensor<i64>, tensor<i64>) -> tensor<i1>
      "stablehlo.return"(%515) : (tensor<i1>) -> ()
    }, {
    ^bb0(%arg157: tensor<3x2xui32>, %arg158: tensor<3xf64>, %arg159: tensor<i64>, %arg160: tensor<3xf64>):
      %486 = "stablehlo.constant"() <{value = dense<0> : tensor<i64>}> : () -> tensor<i64>
      %487 = "stablehlo.compare"(%arg159, %486) <{compare_type = #stablehlo<comparison_type SIGNED>, comparison_direction = #stablehlo<comparison_direction LT>}> : (tensor<i64>, tensor<i64>) -> tensor<i1>
      %488 = "stablehlo.convert"(%arg159) : (tensor<i64>) -> tensor<i64>
      %489 = "stablehlo.constant"() <{value = dense<3> : tensor<i64>}> : () -> tensor<i64>
      %490 = "stablehlo.add"(%488, %489) : (tensor<i64>, tensor<i64>) -> tensor<i64>
      %491 = "stablehlo.select"(%487, %490, %arg159) : (tensor<i1>, tensor<i64>, tensor<i64>) -> tensor<i64>
      %492 = "stablehlo.constant"() <{value = dense<0> : tensor<i64>}> : () -> tensor<i64>
      %493 = "stablehlo.dynamic_slice"(%arg157, %491, %492) <{slice_sizes = array<i64: 1, 2>}> : (tensor<3x2xui32>, tensor<i64>, tensor<i64>) -> tensor<1x2xui32>
      %494 = "stablehlo.reshape"(%493) : (tensor<1x2xui32>) -> tensor<2xui32>
      %495 = "stablehlo.constant"() <{value = dense<0> : tensor<i64>}> : () -> tensor<i64>
      %496 = "stablehlo.compare"(%arg159, %495) <{compare_type = #stablehlo<comparison_type SIGNED>, comparison_direction = #stablehlo<comparison_direction LT>}> : (tensor<i64>, tensor<i64>) -> tensor<i1>
      %497 = "stablehlo.convert"(%arg159) : (tensor<i64>) -> tensor<i64>
      %498 = "stablehlo.constant"() <{value = dense<3> : tensor<i64>}> : () -> tensor<i64>
      %499 = "stablehlo.add"(%497, %498) : (tensor<i64>, tensor<i64>) -> tensor<i64>
      %500 = "stablehlo.select"(%496, %499, %arg159) : (tensor<i1>, tensor<i64>, tensor<i64>) -> tensor<i64>
      %501 = "stablehlo.dynamic_slice"(%arg158, %500) <{slice_sizes = array<i64: 1>}> : (tensor<3xf64>, tensor<i64>) -> tensor<1xf64>
      %502 = "stablehlo.reshape"(%501) : (tensor<1xf64>) -> tensor<f64>
      %503 = "func.call"(%494, %502) <{callee = @None_0}> : (tensor<2xui32>, tensor<f64>) -> tensor<f64>
      %504 = "stablehlo.broadcast_in_dim"(%503) <{broadcast_dimensions = array<i64>}> : (tensor<f64>) -> tensor<1xf64>
      %505 = "stablehlo.constant"() <{value = dense<0> : tensor<i64>}> : () -> tensor<i64>
      %506 = "stablehlo.compare"(%arg159, %505) <{compare_type = #stablehlo<comparison_type SIGNED>, comparison_direction = #stablehlo<comparison_direction LT>}> : (tensor<i64>, tensor<i64>) -> tensor<i1>
      %507 = "stablehlo.convert"(%arg159) : (tensor<i64>) -> tensor<i64>
      %508 = "stablehlo.constant"() <{value = dense<3> : tensor<i64>}> : () -> tensor<i64>
      %509 = "stablehlo.add"(%507, %508) : (tensor<i64>, tensor<i64>) -> tensor<i64>
      %510 = "stablehlo.select"(%506, %509, %arg159) : (tensor<i1>, tensor<i64>, tensor<i64>) -> tensor<i64>
      %511 = "stablehlo.dynamic_update_slice"(%arg160, %504, %510) : (tensor<3xf64>, tensor<1xf64>, tensor<i64>) -> tensor<3xf64>
      %512 = "stablehlo.constant"() <{value = dense<1> : tensor<i64>}> : () -> tensor<i64>
      %513 = "stablehlo.add"(%arg159, %512) : (tensor<i64>, tensor<i64>) -> tensor<i64>
      "stablehlo.return"(%arg157, %arg158, %513, %511) : (tensor<3x2xui32>, tensor<3xf64>, tensor<i64>, tensor<3xf64>) -> ()
    }) : (tensor<3x2xui32>, tensor<3xf64>, tensor<i64>, tensor<3xf64>) -> (tensor<3x2xui32>, tensor<3xf64>, tensor<i64>, tensor<3xf64>)
    "func.return"(%485#3) : (tensor<3xf64>) -> ()
  }) : () -> ()
  "func.func"() <{arg_attrs = [{mhlo.layout_mode = "default"}], function_type = (tensor<1x2xui32>) -> tensor<1x3x2xui32>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "_threefry_split", sym_visibility = "private"}> ({
  ^bb0(%arg136: tensor<1x2xui32>):
    %448 = "stablehlo.iota"() <{iota_dimension = 0 : i64}> : () -> tensor<6xui32>
    %449 = "stablehlo.slice"(%arg136) <{limit_indices = array<i64: 1, 1>, start_indices = array<i64: 0, 0>, strides = array<i64: 1, 1>}> : (tensor<1x2xui32>) -> tensor<1x1xui32>
    %450 = "stablehlo.reshape"(%449) : (tensor<1x1xui32>) -> tensor<1xui32>
    %451 = "stablehlo.slice"(%arg136) <{limit_indices = array<i64: 1, 2>, start_indices = array<i64: 0, 1>, strides = array<i64: 1, 1>}> : (tensor<1x2xui32>) -> tensor<1x1xui32>
    %452 = "stablehlo.reshape"(%451) : (tensor<1x1xui32>) -> tensor<1xui32>
    %453 = "stablehlo.slice"(%448) <{limit_indices = array<i64: 3>, start_indices = array<i64: 0>, strides = array<i64: 1>}> : (tensor<6xui32>) -> tensor<3xui32>
    %454 = "stablehlo.slice"(%448) <{limit_indices = array<i64: 6>, start_indices = array<i64: 3>, strides = array<i64: 1>}> : (tensor<6xui32>) -> tensor<3xui32>
    %455 = "stablehlo.broadcast_in_dim"(%453) <{broadcast_dimensions = array<i64: 1>}> : (tensor<3xui32>) -> tensor<1x3xui32>
    %456 = "stablehlo.broadcast_in_dim"(%454) <{broadcast_dimensions = array<i64: 1>}> : (tensor<3xui32>) -> tensor<1x3xui32>
    %457 = "stablehlo.broadcast_in_dim"(%450) <{broadcast_dimensions = array<i64: 0>}> : (tensor<1xui32>) -> tensor<1x1xui32>
    %458 = "stablehlo.broadcast_in_dim"(%452) <{broadcast_dimensions = array<i64: 0>}> : (tensor<1xui32>) -> tensor<1x1xui32>
    %459 = "stablehlo.constant"() <{value = dense<[13, 15, 26, 6]> : tensor<4xui32>}> : () -> tensor<4xui32>
    %460 = "stablehlo.constant"() <{value = dense<[17, 29, 16, 24]> : tensor<4xui32>}> : () -> tensor<4xui32>
    %461 = "stablehlo.xor"(%457, %458) : (tensor<1x1xui32>, tensor<1x1xui32>) -> tensor<1x1xui32>
    %462 = "stablehlo.constant"() <{value = dense<466688986> : tensor<ui32>}> : () -> tensor<ui32>
    %463 = "stablehlo.broadcast_in_dim"(%462) <{broadcast_dimensions = array<i64>}> : (tensor<ui32>) -> tensor<1x1xui32>
    %464 = "stablehlo.xor"(%461, %463) : (tensor<1x1xui32>, tensor<1x1xui32>) -> tensor<1x1xui32>
    %465 = "stablehlo.broadcast_in_dim"(%457) <{broadcast_dimensions = array<i64: 0, 1>}> : (tensor<1x1xui32>) -> tensor<1x3xui32>
    %466 = "stablehlo.add"(%455, %465) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    %467 = "stablehlo.broadcast_in_dim"(%458) <{broadcast_dimensions = array<i64: 0, 1>}> : (tensor<1x1xui32>) -> tensor<1x3xui32>
    %468 = "stablehlo.add"(%456, %467) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    %469 = "stablehlo.constant"() <{value = dense<0> : tensor<i64>}> : () -> tensor<i64>
    %470 = "stablehlo.constant"() <{value = dense<0> : tensor<i64>}> : () -> tensor<i64>
    %471:9 = "stablehlo.while"(%470, %469, %466, %468, %458, %464, %457, %459, %460) ({
    ^bb0(%arg146: tensor<i64>, %arg147: tensor<i64>, %arg148: tensor<1x3xui32>, %arg149: tensor<1x3xui32>, %arg150: tensor<1x1xui32>, %arg151: tensor<1x1xui32>, %arg152: tensor<1x1xui32>, %arg153: tensor<4xui32>, %arg154: tensor<4xui32>):
      %477 = "stablehlo.constant"() <{value = dense<5> : tensor<i64>}> : () -> tensor<i64>
      %478 = "stablehlo.compare"(%arg146, %477) <{compare_type = #stablehlo<comparison_type SIGNED>, comparison_direction = #stablehlo<comparison_direction LT>}> : (tensor<i64>, tensor<i64>) -> tensor<i1>
      "stablehlo.return"(%478) : (tensor<i1>) -> ()
    }, {
    ^bb0(%arg137: tensor<i64>, %arg138: tensor<i64>, %arg139: tensor<1x3xui32>, %arg140: tensor<1x3xui32>, %arg141: tensor<1x1xui32>, %arg142: tensor<1x1xui32>, %arg143: tensor<1x1xui32>, %arg144: tensor<4xui32>, %arg145: tensor<4xui32>):
      %474:8 = "func.call"(%arg138, %arg139, %arg140, %arg141, %arg142, %arg143, %arg144, %arg145) <{callee = @None}> : (tensor<i64>, tensor<1x3xui32>, tensor<1x3xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<4xui32>, tensor<4xui32>) -> (tensor<i64>, tensor<1x3xui32>, tensor<1x3xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<4xui32>, tensor<4xui32>)
      %475 = "stablehlo.constant"() <{value = dense<1> : tensor<i64>}> : () -> tensor<i64>
      %476 = "stablehlo.add"(%arg137, %475) : (tensor<i64>, tensor<i64>) -> tensor<i64>
      "stablehlo.return"(%476, %474#0, %474#1, %474#2, %474#3, %474#4, %474#5, %474#6, %474#7) : (tensor<i64>, tensor<i64>, tensor<1x3xui32>, tensor<1x3xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<4xui32>, tensor<4xui32>) -> ()
    }) : (tensor<i64>, tensor<i64>, tensor<1x3xui32>, tensor<1x3xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<4xui32>, tensor<4xui32>) -> (tensor<i64>, tensor<i64>, tensor<1x3xui32>, tensor<1x3xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<4xui32>, tensor<4xui32>)
    %472 = "stablehlo.concatenate"(%471#2, %471#3) <{dimension = 1 : i64}> : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x6xui32>
    %473 = "stablehlo.reshape"(%472) : (tensor<1x6xui32>) -> tensor<1x3x2xui32>
    "func.return"(%473) : (tensor<1x3x2xui32>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = (tensor<i64>, tensor<1x3xui32>, tensor<1x3xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<4xui32>, tensor<4xui32>) -> (tensor<i64>, tensor<1x3xui32>, tensor<1x3xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<4xui32>, tensor<4xui32>), sym_name = "None", sym_visibility = "private"}> ({
  ^bb0(%arg128: tensor<i64>, %arg129: tensor<1x3xui32>, %arg130: tensor<1x3xui32>, %arg131: tensor<1x1xui32>, %arg132: tensor<1x1xui32>, %arg133: tensor<1x1xui32>, %arg134: tensor<4xui32>, %arg135: tensor<4xui32>):
    ...
    %397 = "stablehlo.add"(%arg129, %arg130) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    %398 = "stablehlo.broadcast_in_dim"(%396) <{broadcast_dimensions = array<i64>}> : (tensor<ui32>) -> tensor<1x3xui32>
    %399 = "stablehlo.shift_left"(%arg130, %398) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    ...
    %402 = "stablehlo.broadcast_in_dim"(%401) <{broadcast_dimensions = array<i64>}> : (tensor<ui32>) -> tensor<1x3xui32>
    %403 = "stablehlo.shift_right_logical"(%arg130, %402) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    %404 = "stablehlo.or"(%399, %403) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    %405 = "stablehlo.xor"(%397, %404) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    ...
    %408 = "stablehlo.add"(%397, %405) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    %409 = "stablehlo.broadcast_in_dim"(%407) <{broadcast_dimensions = array<i64>}> : (tensor<ui32>) -> tensor<1x3xui32>
    %410 = "stablehlo.shift_left"(%405, %409) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    ...
    %413 = "stablehlo.broadcast_in_dim"(%412) <{broadcast_dimensions = array<i64>}> : (tensor<ui32>) -> tensor<1x3xui32>
    %414 = "stablehlo.shift_right_logical"(%405, %413) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    %415 = "stablehlo.or"(%410, %414) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    %416 = "stablehlo.xor"(%408, %415) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    ...
    %419 = "stablehlo.add"(%408, %416) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    %420 = "stablehlo.broadcast_in_dim"(%418) <{broadcast_dimensions = array<i64>}> : (tensor<ui32>) -> tensor<1x3xui32>
    %421 = "stablehlo.shift_left"(%416, %420) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    ...
    %424 = "stablehlo.broadcast_in_dim"(%423) <{broadcast_dimensions = array<i64>}> : (tensor<ui32>) -> tensor<1x3xui32>
    %425 = "stablehlo.shift_right_logical"(%416, %424) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    %426 = "stablehlo.or"(%421, %425) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    %427 = "stablehlo.xor"(%419, %426) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    ...
    %430 = "stablehlo.add"(%419, %427) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    %431 = "stablehlo.broadcast_in_dim"(%429) <{broadcast_dimensions = array<i64>}> : (tensor<ui32>) -> tensor<1x3xui32>
    %432 = "stablehlo.shift_left"(%427, %431) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    ...
    %435 = "stablehlo.broadcast_in_dim"(%434) <{broadcast_dimensions = array<i64>}> : (tensor<ui32>) -> tensor<1x3xui32>
    %436 = "stablehlo.shift_right_logical"(%427, %435) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    %437 = "stablehlo.or"(%432, %436) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    %438 = "stablehlo.xor"(%430, %437) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    %439 = "stablehlo.broadcast_in_dim"(%arg131) <{broadcast_dimensions = array<i64: 0, 1>}> : (tensor<1x1xui32>) -> tensor<1x3xui32>
    %440 = "stablehlo.add"(%430, %439) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    %441 = "stablehlo.broadcast_in_dim"(%arg132) <{broadcast_dimensions = array<i64: 0, 1>}> : (tensor<1x1xui32>) -> tensor<1x3xui32>
    %442 = "stablehlo.add"(%438, %441) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    %443 = "stablehlo.constant"() <{value = dense<1> : tensor<i64>}> : () -> tensor<i64>
    %444 = "stablehlo.add"(%arg128, %443) : (tensor<i64>, tensor<i64>) -> tensor<i64>
    %445 = "stablehlo.convert"(%444) : (tensor<i64>) -> tensor<ui32>
    %446 = "stablehlo.broadcast_in_dim"(%445) <{broadcast_dimensions = array<i64>}> : (tensor<ui32>) -> tensor<1x3xui32>
    %447 = "stablehlo.add"(%442, %446) : (tensor<1x3xui32>, tensor<1x3xui32>) -> tensor<1x3xui32>
    "func.return"(%394, %440, %447, %arg132, %arg133, %arg131, %arg135, %arg134) : (tensor<i64>, tensor<1x3xui32>, tensor<1x3xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<4xui32>, tensor<4xui32>) -> ()
  }) : () -> ()
