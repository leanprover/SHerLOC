"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "cbrt_op_test_f64"}> ({
    %2 = "stablehlo.constant"() <{value = dense<[0.000000e+00, 1.000000e+00, 8.000000e+00, 2.700000e+01]> : tensor<4xf64>}> : () -> tensor<4xf64>
    %3 = "stablehlo.cbrt"(%2) : (tensor<4xf64>) -> tensor<4xf64>
    "check.expect_almost_eq_const"(%3) <{value = dense<[0.000000e+00, 1.000000e+00, 2.000000e+00, 3.000000e+00]> : tensor<4xf64>}> : (tensor<4xf64>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
