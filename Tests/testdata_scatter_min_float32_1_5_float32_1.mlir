"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<1x5xf32>, tensor<1xf32>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[-3.29836416, -0.472510606, 1.60520673, -1.61774409, 0.0900490731]]> : tensor<1x5xf32>}> : () -> tensor<1x5xf32>
    %2 = "stablehlo.constant"() <{value = dense<-1.15384805> : tensor<1xf32>}> : () -> tensor<1xf32>
  ...
  "func.func"() <{function_type = () -> tensor<1x5xf32>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[-3.29836416, -0.472510606, 1.60520673, -1.61774409, 0.0900490731]]> : tensor<1x5xf32>}> : () -> tensor<1x5xf32>
