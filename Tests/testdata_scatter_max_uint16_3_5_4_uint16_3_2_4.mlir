"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<3x5x4xui16>, tensor<3x2x4xui16>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[2, 0, 1, 2], [0, 3, 2, 4], [5, 1, 0, 0], [0, 4, 1, 0], [3, 2, 3, 4]], [[1, 1, 4, 1], [1, 1, 0, 0], [10, 3, 2, 3], [0, 0, 2, 3], [0, 1, 0, 1]], [[0, 1, 2, 0], [2, 1, 3, 3], [1, 7, 0, 1], [6, 3, 6, 3], [1, 2, 4, 1]]]> : tensor<3x5x4xui16>}> : () -> tensor<3x5x4xui16>
    %2 = "stablehlo.constant"() <{value = dense<[[[1, 0, 2, 0], [2, 1, 0, 4]], [[4, 7, 0, 2], [1, 4, 0, 1]], [[0, 0, 1, 4], [1, 2, 3, 2]]]> : tensor<3x2x4xui16>}> : () -> tensor<3x2x4xui16>
  ...
  "func.func"() <{function_type = () -> tensor<3x5x4xui16>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[2, 0, 1, 2], [2, 3, 2, 4], [5, 1, 0, 0], [0, 4, 1, 0], [3, 2, 3, 4]], [[1, 1, 4, 1], [4, 7, 0, 2], [10, 3, 2, 3], [0, 0, 2, 3], [0, 1, 0, 1]], [[0, 1, 2, 0], [2, 2, 3, 4], [1, 7, 0, 1], [6, 3, 6, 3], [1, 2, 4, 1]]]> : tensor<3x5x4xui16>}> : () -> tensor<3x5x4xui16>
