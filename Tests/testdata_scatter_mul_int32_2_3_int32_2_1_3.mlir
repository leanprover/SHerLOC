"builtin.module"() <{sym_name = "jit_main"}> ({
  "func.func"() <{function_type = () -> tensor<2x3xi32>, res_attrs = [{jax.result_info = "", mhlo.layout_mode = "default"}], sym_name = "main", sym_visibility = "public"}> ({
    ...
    %4:2 = "func.call"() <{callee = @inputs}> : () -> (tensor<2x3xi32>, tensor<2x1x3xi32>)
    ...
    }) : (tensor<2x3xi32>, tensor<1x3x1xi64>, tensor<2x1x3xi32>) -> tensor<2x3xi32>
  ...
  "func.func"() <{function_type = () -> (tensor<2x3xi32>, tensor<2x1x3xi32>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[-3, -3, 3], [2, 0, -2]]> : tensor<2x3xi32>}> : () -> tensor<2x3xi32>
    %2 = "stablehlo.constant"() <{value = dense<[[[-1, -2, 6]], [[0, -7, 1]]]> : tensor<2x1x3xi32>}> : () -> tensor<2x1x3xi32>
    "func.return"(%1, %2) : (tensor<2x3xi32>, tensor<2x1x3xi32>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = () -> tensor<2x3xi32>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[-3, -3, 36], [2, 0, 0]]> : tensor<2x3xi32>}> : () -> tensor<2x3xi32>
