"builtin.module"() <{sym_name = "jit_fun_flat_jax"}> ({
  ...
  ^bb0(%arg6: tensor<i64>, %arg7: tensor<?x4xf32>):
    %17 = "func.call"(%arg6, %arg7) <{callee = @argmin}> : (tensor<i64>, tensor<?x4xf32>) -> tensor<?xi32>
    "func.return"(%17) : (tensor<?xi32>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = (tensor<i64>, tensor<?x4xf32>) -> tensor<?xi32>, sym_name = "argmin", sym_visibility = "private"}> ({
