...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "subtract_op_test_f32"}> ({
    ...
    %2 = "stablehlo.subtract"(%0, %1) : (tensor<11xf32>, tensor<11xf32>) -> tensor<11xf32>
    "check.expect_almost_eq_const"(%2) <{value = dense<[0.000000e+00, 0.000000e+00, -6.000000e+00, -6.250000e-01, -0.200000018, 0.000000e+00, 0x7F800000, 0x7FC00000, 0x7FC00000, 0x7F800000, 2.802600e-45]> : tensor<11xf32>}> : (tensor<11xf32>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "subtract_op_test_c64"}> ({
    ...
    %2 = "stablehlo.subtract"(%0, %1) : (tensor<2xcomplex<f32>>, tensor<2xcomplex<f32>>) -> tensor<2xcomplex<f32>>
    "check.expect_almost_eq_const"(%2) <{value = dense<(0.000000e+00,0.000000e+00)> : tensor<2xcomplex<f32>>}> : (tensor<2xcomplex<f32>>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
