"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<1x2x3xi32>, tensor<2x3xi32>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[-3, -1, 0], [2, 0, -3]]]> : tensor<1x2x3xi32>}> : () -> tensor<1x2x3xi32>
    %2 = "stablehlo.constant"() <{value = dense<[[2, -1, 2], [0, 5, 1]]> : tensor<2x3xi32>}> : () -> tensor<2x3xi32>
  ...
  "func.func"() <{function_type = () -> tensor<1x2x3xi32>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[-1, -2, 2], [2, 5, -2]]]> : tensor<1x2x3xi32>}> : () -> tensor<1x2x3xi32>
