"builtin.module"() <{sym_name = "jit_main"}> ({
  "func.func"() <{function_type = () -> tensor<i32>, res_attrs = [{jax.result_info = "", mhlo.layout_mode = "default"}], sym_name = "main", sym_visibility = "public"}> ({
    ...
    %17 = "func.call"(%15) <{callee = @argmin}> : (tensor<15xf32>) -> tensor<i32>
  ...
  "func.func"() <{function_type = () -> tensor<15xf32>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %14 = "stablehlo.constant"() <{value = dense<[6.35748625, 4.95101643, -3.98811984, 3.48766541, -0.183460131, -6.65203094, -3.81321788, -5.37809229, 0.617416382, 0.422738254, 5.51293945, 3.88155174, 3.41454244, -3.49898648, 2.92918921]> : tensor<15xf32>}> : () -> tensor<15xf32>
  ...
  "func.func"() <{function_type = () -> tensor<i32>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %13 = "stablehlo.constant"() <{value = dense<5> : tensor<i32>}> : () -> tensor<i32>
    "func.return"(%13) : (tensor<i32>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = (tensor<15xf32>) -> tensor<i32>, sym_name = "argmin", sym_visibility = "private"}> ({
  ^bb0(%arg0: tensor<15xf32>):
    ...
    }) : (tensor<15xf32>, tensor<15xi32>, tensor<f32>, tensor<i32>) -> (tensor<f32>, tensor<i32>)
