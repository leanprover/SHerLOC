"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "exponential_minus_one_op_test_f64"}> ({
    %2 = "stablehlo.constant"() <{value = dense<[0.000000e+00, 1.000000e+00]> : tensor<2xf64>}> : () -> tensor<2xf64>
    %3 = "stablehlo.exponential_minus_one"(%2) : (tensor<2xf64>) -> tensor<2xf64>
    "check.expect_almost_eq_const"(%3) <{value = dense<[0.000000e+00, 1.7182818284590451]> : tensor<2xf64>}> : (tensor<2xf64>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
