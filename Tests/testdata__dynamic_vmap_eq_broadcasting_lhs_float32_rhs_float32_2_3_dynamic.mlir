"builtin.module"() <{sym_name = "jit_fun_flat_jax"}> ({
  ...
  ^bb0(%arg0: tensor<i64>, %arg1: tensor<?xf32>, %arg2: tensor<?x2x3xf32>):
    ...
    %12 = "stablehlo.compare"(%11, %arg2) <{compare_type = #stablehlo<comparison_type FLOAT>, comparison_direction = #stablehlo<comparison_direction EQ>}> : (tensor<?x2x3xf32>, tensor<?x2x3xf32>) -> tensor<?x2x3xi1>
