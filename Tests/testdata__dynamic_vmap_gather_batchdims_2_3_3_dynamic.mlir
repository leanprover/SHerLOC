"builtin.module"() <{sym_name = "jit_fun_flat_jax"}> ({
  "func.func"() <{arg_attrs = [{}, {mhlo.sharding = ""}, {mhlo.sharding = ""}], function_type = (tensor<i64>, tensor<?x2x3x3xf32>, tensor<?x2x3xi64>) -> tensor<?x2x3x2xf32>, sym_name = "main", sym_visibility = "public"}> ({
  ^bb0(%arg0: tensor<i64>, %arg1: tensor<?x2x3x3xf32>, %arg2: tensor<?x2x3xi64>):
    ...
    %6 = "stablehlo.concatenate"(%5, %arg2) <{dimension = 2 : i64}> : (tensor<?x2x1xi64>, tensor<?x2x3xi64>) -> tensor<?x2x4xi64>
    ...
    "func.return"(%7) : (tensor<?x2x3x2xf32>) -> ()
  }) : () -> ()
}) : () -> ()
