"builtin.module"() <{sym_name = "jit_fun_flat_jax"}> ({
  "func.func"() <{arg_attrs = [{}, {mhlo.sharding = ""}, {mhlo.sharding = ""}], function_type = (tensor<i64>, tensor<?x2x3x4xf32>, tensor<?x2x4x6xf32>) -> tensor<?x2x4x6xf32>, sym_name = "main", sym_visibility = "public"}> ({
  ^bb0(%arg0: tensor<i64>, %arg1: tensor<?x2x3x4xf32>, %arg2: tensor<?x2x4x6xf32>):
    ...
    %3 = "stablehlo.select_and_scatter"(%1, %arg1, %2) <{window_dimensions = array<i64: 1, 1, 2, 3>}> ({
    ...
    }) : (tensor<?x2x4x6xf32>, tensor<?x2x3x4xf32>, tensor<f32>) -> tensor<?x2x4x6xf32>
