"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<3x5x4xi64>, tensor<3x2x4xi64>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[-1, 1, -2, -2], [3, 7, 2, 2], [6, 0, 0, -3], [0, 0, -2, -1], [7, 5, -4, 2]], [[1, 0, 0, 0], [2, -3, -2, 0], [0, -2, -4, -2], [-2, -2, 3, -2], [1, -3, -1, 1]], [[3, 2, -3, 1], [1, 3, 2, 0], [-6, -1, 1, 1], [0, 0, 0, 0], [0, -4, 0, 0]]]> : tensor<3x5x4xi64>}> : () -> tensor<3x5x4xi64>
    %2 = "stablehlo.constant"() <{value = dense<[[[3, -1, 3, -2], [6, 0, -3, -2]], [[-4, 0, 0, 1], [-1, -1, 4, 0]], [[0, 0, -1, -3], [-5, 2, -1, 1]]]> : tensor<3x2x4xi64>}> : () -> tensor<3x2x4xi64>
  ...
  "func.func"() <{function_type = () -> tensor<3x5x4xi64>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[-1, 1, -2, -2], [54, 0, -18, 8], [6, 0, 0, -3], [0, 0, -2, -1], [7, 5, -4, 2]], [[1, 0, 0, 0], [8, 0, 0, 0], [0, -2, -4, -2], [-2, -2, 3, -2], [1, -3, -1, 1]], [[3, 2, -3, 1], [0, 0, 2, 0], [-6, -1, 1, 1], [0, 0, 0, 0], [0, -4, 0, 0]]]> : tensor<3x5x4xi64>}> : () -> tensor<3x5x4xi64>
