...
"builtin.module"() ({
  "func.func"() <{function_type = () -> tensor<11xf32>, sym_name = "main"}> ({
    ...
    %2 = "stablehlo.constant"() <{value = dense<[0.000000e+00, 0.000000e+00, 0.972242116, 0.0953178555, 0.030501714, 0.972242116, 0.000000e+00, 0.972242116, 0.000000e+00, 0.000000e+00, 0.000000e+00]> : tensor<11xf32>}> : () -> tensor<11xf32>
    ...
    %5 = "stablehlo.multiply"(%4, %3) : (tensor<11x!quant.uniform<i8:f32, 0.0039172410964965817:-128>>, tensor<11x!quant.uniform<i8:f32, 0.0039188104517319626:-128>>) -> tensor<11x!quant.uniform<i8:f32, 0.0038127141840317669:-128>>
    %6 = "stablehlo.uniform_dequantize"(%5) : (tensor<11x!quant.uniform<i8:f32, 0.0038127141840317669:-128>>) -> tensor<11xf32>
...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "mul_op_test_c64"}> ({
    ...
    %1 = "stablehlo.multiply"(%0, %0) : (tensor<2xcomplex<f32>>, tensor<2xcomplex<f32>>) -> tensor<2xcomplex<f32>>
    "check.expect_almost_eq_const"(%1) <{value = dense<[(-4.000000e+00,7.500000e+00), (2.600000e+01,8.250000e+01)]> : tensor<2xcomplex<f32>>}> : (tensor<2xcomplex<f32>>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "mul_op_test_c128"}> ({
    ...
    %1 = "stablehlo.multiply"(%0, %0) : (tensor<2xcomplex<f64>>, tensor<2xcomplex<f64>>) -> tensor<2xcomplex<f64>>
    "check.expect_almost_eq_const"(%1) <{value = dense<[(-4.000000e+00,7.500000e+00), (2.600000e+01,8.250000e+01)]> : tensor<2xcomplex<f64>>}> : (tensor<2xcomplex<f64>>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
