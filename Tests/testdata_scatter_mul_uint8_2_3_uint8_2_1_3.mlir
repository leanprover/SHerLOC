"builtin.module"() <{sym_name = "jit_main"}> ({
  "func.func"() <{function_type = () -> tensor<2x3xui8>, res_attrs = [{jax.result_info = "", mhlo.layout_mode = "default"}], sym_name = "main", sym_visibility = "public"}> ({
    ...
    %4:2 = "func.call"() <{callee = @inputs}> : () -> (tensor<2x3xui8>, tensor<2x1x3xui8>)
  ...
  "func.func"() <{function_type = () -> (tensor<2x3xui8>, tensor<2x1x3xui8>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[3, 0, 4], [2, 4, 0]]> : tensor<2x3xui8>}> : () -> tensor<2x3xui8>
    %2 = "stablehlo.constant"() <{value = dense<[[[4, 5, 2]], [[1, 0, 7]]]> : tensor<2x1x3xui8>}> : () -> tensor<2x1x3xui8>
    "func.return"(%1, %2) : (tensor<2x3xui8>, tensor<2x1x3xui8>) -> ()
  }) : () -> ()
  "func.func"() <{function_type = () -> tensor<2x3xui8>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[3, 0, 160], [2, 4, 0]]> : tensor<2x3xui8>}> : () -> tensor<2x3xui8>
