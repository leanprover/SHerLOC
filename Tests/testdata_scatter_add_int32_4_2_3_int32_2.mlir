"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<4x2x3xi32>, tensor<2xi32>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[-1, -1, -4], [2, 0, 4]], [[5, 0, -2], [-1, 4, -1]], [[0, 0, -1], [3, 0, -1]], [[-3, 1, 0], [0, 2, -1]]]> : tensor<4x2x3xi32>}> : () -> tensor<4x2x3xi32>
    %2 = "stablehlo.constant"() <{value = dense<[0, -3]> : tensor<2xi32>}> : () -> tensor<2xi32>
  ...
  "func.func"() <{function_type = () -> tensor<4x2x3xi32>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[-1, -1, -4], [2, 0, 4]], [[5, 0, -2], [-1, 4, -1]], [[0, 0, -1], [3, 0, -1]], [[-3, 1, 0], [0, 2, -4]]]> : tensor<4x2x3xi32>}> : () -> tensor<4x2x3xi32>
