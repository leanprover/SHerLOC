"builtin.module"() <{sym_name = "jit_main"}> ({
  "func.func"() <{function_type = () -> tensor<2xf32>, res_attrs = [{jax.result_info = "", mhlo.layout_mode = "default"}], sym_name = "main", sym_visibility = "public"}> ({
    ...
    %4 = "stablehlo.reshape"(%2) : (tensor<1x2xf32>) -> tensor<2xf32>
  ...
  "func.func"() <{function_type = () -> tensor<1x2xf32>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[0.578051805, 1.69534159]]> : tensor<1x2xf32>}> : () -> tensor<1x2xf32>
  ...
  "func.func"() <{function_type = () -> tensor<2xf32>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[0.578051805, 1.69534159]> : tensor<2xf32>}> : () -> tensor<2xf32>
