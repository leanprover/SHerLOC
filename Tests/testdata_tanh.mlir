...
"builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "tanh_op_test_f32"}> ({
    ...
    %1 = "stablehlo.tanh"(%0) : (tensor<11xf32>) -> tensor<11xf32>
    "check.expect_almost_eq_const"(%1) <{value = dense<[0.000000e+00, -0.000000e+00, 0.761594176, 1.243530e-01, 0.0996679961, 0.996272087, 1.000000e+00, -1.000000e+00, 0x7FFFFFFF, 1.401300e-45, -1.401300e-45]> : tensor<11xf32>}> : (tensor<11xf32>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
