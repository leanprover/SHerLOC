"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<3xf32>, tensor<3xf32>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[-4.15707779, -2.23386383, 0.0766598135]> : tensor<3xf32>}> : () -> tensor<3xf32>
    %2 = "stablehlo.constant"() <{value = dense<[7.539640e+00, -0.0942436829, 2.39863491]> : tensor<3xf32>}> : () -> tensor<3xf32>
  ...
  "func.func"() <{function_type = () -> tensor<3xf32>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[-4.15707779, -2.23386383, 0.0766598135]> : tensor<3xf32>}> : () -> tensor<3xf32>
