"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<3x5x4xui32>, tensor<3x2x4xui32>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[4, 1, 2, 0], [1, 0, 3, 1], [0, 1, 0, 4], [2, 0, 5, 0], [4, 4, 1, 2]], [[1, 2, 3, 2], [4, 1, 2, 1], [2, 3, 2, 0], [0, 2, 0, 2], [1, 3, 6, 1]], [[1, 3, 0, 1], [3, 1, 0, 0], [0, 2, 3, 2], [4, 4, 2, 2], [1, 4, 0, 2]]]> : tensor<3x5x4xui32>}> : () -> tensor<3x5x4xui32>
    %2 = "stablehlo.constant"() <{value = dense<[[[0, 4, 1, 0], [2, 3, 0, 0]], [[3, 3, 1, 4], [1, 1, 5, 3]], [[1, 6, 4, 3], [2, 0, 2, 1]]]> : tensor<3x2x4xui32>}> : () -> tensor<3x2x4xui32>
  ...
  "func.func"() <{function_type = () -> tensor<3x5x4xui32>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[4, 1, 2, 0], [3, 7, 4, 1], [0, 1, 0, 4], [2, 0, 5, 0], [4, 4, 1, 2]], [[1, 2, 3, 2], [8, 5, 8, 8], [2, 3, 2, 0], [0, 2, 0, 2], [1, 3, 6, 1]], [[1, 3, 0, 1], [6, 7, 6, 4], [0, 2, 3, 2], [4, 4, 2, 2], [1, 4, 0, 2]]]> : tensor<3x5x4xui32>}> : () -> tensor<3x5x4xui32>
