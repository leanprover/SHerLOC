"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<3x5x4xui64>, tensor<3x2x4xui64>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[3, 0, 0, 4], [3, 0, 2, 5], [0, 1, 0, 5], [1, 2, 4, 0], [4, 5, 4, 1]], [[3, 0, 3, 5], [4, 2, 2, 6], [2, 0, 5, 5], [3, 1, 2, 1], [6, 5, 5, 2]], [[0, 6, 0, 6], [1, 6, 1, 0], [5, 0, 2, 2], [0, 1, 1, 1], [1, 3, 2, 5]]]> : tensor<3x5x4xui64>}> : () -> tensor<3x5x4xui64>
    %2 = "stablehlo.constant"() <{value = dense<[[[5, 3, 4, 2], [0, 2, 4, 1]], [[0, 0, 1, 3], [4, 0, 0, 3]], [[1, 0, 0, 1], [2, 3, 3, 0]]]> : tensor<3x2x4xui64>}> : () -> tensor<3x2x4xui64>
  ...
  "func.func"() <{function_type = () -> tensor<3x5x4xui64>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[3, 0, 0, 4], [5, 3, 4, 5], [0, 1, 0, 5], [1, 2, 4, 0], [4, 5, 4, 1]], [[3, 0, 3, 5], [4, 2, 2, 6], [2, 0, 5, 5], [3, 1, 2, 1], [6, 5, 5, 2]], [[0, 6, 0, 6], [2, 6, 3, 1], [5, 0, 2, 2], [0, 1, 1, 1], [1, 3, 2, 5]]]> : tensor<3x5x4xui64>}> : () -> tensor<3x5x4xui64>
