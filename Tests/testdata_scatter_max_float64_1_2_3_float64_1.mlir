"builtin.module"() <{sym_name = "jit_main"}> ({
  ...
  "func.func"() <{function_type = () -> (tensor<1x2x3xf64>, tensor<1xf64>), res_attrs = [{mhlo.layout_mode = "default"}, {mhlo.layout_mode = "default"}], sym_name = "inputs", sym_visibility = "private"}> ({
    %1 = "stablehlo.constant"() <{value = dense<[[[-0.83491965300219362, 3.5071799224422731, -2.2717038073289566], [1.083709704103605, -1.5394424735727816, 0.37392860468258909]]]> : tensor<1x2x3xf64>}> : () -> tensor<1x2x3xf64>
    %2 = "stablehlo.constant"() <{value = dense<-0.21642376553613452> : tensor<1xf64>}> : () -> tensor<1xf64>
  ...
  "func.func"() <{function_type = () -> tensor<1x2x3xf64>, res_attrs = [{mhlo.layout_mode = "default"}], sym_name = "expected", sym_visibility = "private"}> ({
    %0 = "stablehlo.constant"() <{value = dense<[[[-0.83491965300219362, 3.5071799224422731, -2.2717038073289566], [1.083709704103605, -1.5394424735727816, 0.37392860468258909]]]> : tensor<1x2x3xf64>}> : () -> tensor<1x2x3xf64>
